...
```php
$accountsVerificationsController = $client->getAccountsVerificationsController();
```
...
```php
function getAccountVerificationsId(
    string $id,
    ?string $token = null,
...
[`AccountVerificationsResponseResult`](../../doc/models/account-verifications-response-result.md)
...
$result = $accountsVerificationsController->getAccountVerificationsId(
    $id,
    $token,
    $requestToken
);
...
$result = $accountsVerificationsController->getAccountVerifications(
    $token,
    $requestToken,
    $search,
    $totals,
