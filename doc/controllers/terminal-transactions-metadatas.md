...
```php
$terminalTransactionsMetadatasController = $client->getTerminalTransactionsMetadatasController();
```
...
```php
function getTerminalTxnsMetadatasId(
    string $id,
    ?string $token = null,
...
[`TerminalTxnMetadatasResponseResult`](../../doc/models/terminal-txn-metadatas-response-result.md)
...
$result = $terminalTransactionsMetadatasController->getTerminalTxnsMetadatasId(
    $id,
    $token,
    $requestToken
);
...
```php
function getTerminalTxnsMetadatas(
    ?string $token = null,
    ?string $requestToken = null,
    ?string $search = null,
    ?string $totals = null,
...
$result = $terminalTransactionsMetadatasController->getTerminalTxnsMetadatas(
    $token,
    $requestToken,
    $search,
    $totals,
...
```php
function postTerminalTxnsMetadatas(
    TerminalTxnsMetadatasPostRequest $body,
    ?string $token = null,
    ?string $requestToken = null
): TerminalTxnMetadatasResponseResult
```
...
```php
$body = TerminalTxnsMetadatasPostRequestBuilder::init(
    't1_ttx_6806cde42b47ee61cdf6ab9',
    TerminalTxnMetadataTypeEnum::DISCRETIONARY,
    TerminalTxnsMetadatasFieldEnum::DISCRETIONARY1,
    '0421'
)->build();
...
$result = $terminalTransactionsMetadatasController->postTerminalTxnsMetadatas(
    $body,
    $token,
    $requestToken
);
