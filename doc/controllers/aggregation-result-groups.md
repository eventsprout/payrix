...
```php
$aggregationResultGroupsController = $client->getAggregationResultGroupsController();
```
...
```php
function getAggregationResultGroupsId(
    string $id,
    ?string $token = null,
...
|  --- | --- | --- | --- |
| `id` | `string` | Template, Required | The ID of this resource or The Aggregation Result Group ID. |
...
[`AggregationResultsGroupsResponseResult`](../../doc/models/aggregation-results-groups-response-result.md)
...
$result = $aggregationResultGroupsController->getAggregationResultGroupsId(
    $id,
    $token,
    $requestToken
);
...
```php
function deleteAggregationResultGroupsId(
    string $id,
    ?string $token = null,
    ?string $requestToken = null,
...
$result = $aggregationResultGroupsController->deleteAggregationResultGroupsId(
    $id,
    $token,
    $requestToken,
    $searchFilter
...
```php
function getAggregationResultGroups(
    ?string $token = null,
    ?string $requestToken = null,
    ?string $search = null,
    ?string $totals = null,
...
$result = $aggregationResultGroupsController->getAggregationResultGroups(
    $token,
    $requestToken,
    $search,
    $totals,
