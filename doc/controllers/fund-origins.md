...
```php
$fundOriginsController = $client->getFundOriginsController();
```
...
|  --- | --- | --- | --- |
| `id` | `string` | Template, Required | The ID of this resource and The Fund Origin ID. |
...
[`FundOriginsResponseResult`](../../doc/models/fund-origins-response-result.md)
...
$result = $fundOriginsController->getFundOriginsId(
    $id,
    $token,
    $requestToken
);
...
$result = $fundOriginsController->getFundOrigins(
    $token,
    $requestToken,
    $search,
    $totals,
