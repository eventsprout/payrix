...
```php
$disbursementReferenceController = $client->getDisbursementReferenceController();
```
...
```php
function getDisbursementRefsId(
    string $id,
    ?string $token = null,
...
|  --- | --- | --- | --- |
| `id` | `string` | Template, Required | The ID of this resource, also known as The Disbursement Reference ID. |
...
[`DisbursementRefsResponseResult`](../../doc/models/disbursement-refs-response-result.md)
...
$result = $disbursementReferenceController->getDisbursementRefsId(
    $id,
    $token,
    $requestToken
);
...
$result = $disbursementReferenceController->getDisbursementRefs(
    $token,
    $requestToken,
    $search,
    $totals,
