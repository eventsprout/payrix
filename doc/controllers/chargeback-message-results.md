...
```php
$chargebackMessageResultsController = $client->getChargebackMessageResultsController();
```
...
```php
function getChargebackMessageResultsId(
    string $id,
    ?string $token = null,
...
|  --- | --- | --- | --- |
| `id` | `string` | Template, Required | The Chargeback Message Result ID of this resource. |
...
[`ChargebackMessageResultsResponseResult`](../../doc/models/chargeback-message-results-response-result.md)
...
$result = $chargebackMessageResultsController->getChargebackMessageResultsId(
    $id,
    $token,
    $requestToken
);
...
```php
function getChargebackMessageResults(
    ?string $token = null,
    ?string $requestToken = null,
    ?string $search = null,
    ?string $totals = null,
...
$result = $chargebackMessageResultsController->getChargebackMessageResults(
    $token,
    $requestToken,
    $search,
    $totals,
