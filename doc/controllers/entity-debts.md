...
```php
$entityDebtsController = $client->getEntityDebtsController();
```
...
|  --- | --- | --- | --- |
| `id` | `string` | Template, Required | The ID of this entity debt. |
...
[`EntityDebtsResponseResult`](../../doc/models/entity-debts-response-result.md)
...
$result = $entityDebtsController->getEntityDebtsId(
    $id,
    $token,
    $requestToken
);
...
$result = $entityDebtsController->getEntityDebts(
    $token,
    $requestToken,
    $search,
    $totals,
