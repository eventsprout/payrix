...
```php
$appleDomainsController = $client->getAppleDomainsController();
```
...
[`AppleDomainsResponseResult`](../../doc/models/apple-domains-response-result.md)
...
$result = $appleDomainsController->getAppleDomainsId(
    $id,
    $token,
    $requestToken
);
...
$result = $appleDomainsController->getAppleDomains(
    $token,
    $requestToken,
    $search,
    $totals,
