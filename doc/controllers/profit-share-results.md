...
```php
$profitShareResultsController = $client->getProfitShareResultsController();
```
...
```php
function getProfitShareResultsId(
    string $id,
    ?string $token = null,
...
|  --- | --- | --- | --- |
| `id` | `string` | Template, Required | The ID of this resource, The Profit Share Result ID. |
...
[`ProfitShareResultsResponseResult`](../../doc/models/profit-share-results-response-result.md)
...
$result = $profitShareResultsController->getProfitShareResultsId(
    $id,
    $token,
    $requestToken
);
...
```php
function getProfitShareResults(
    ?string $token = null,
    ?string $requestToken = null,
    ?string $search = null,
    ?string $totals = null,
...
$result = $profitShareResultsController->getProfitShareResults(
    $token,
    $requestToken,
    $search,
    $totals,
