...
# Fraud Sight Results Response Item
...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(FraudSightResultsResponse[])`](../../doc/models/fraud-sight-results-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
