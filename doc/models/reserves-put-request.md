...
| `org` | `?string` | Optional | The identifier of the Org that this Reserve's resource applies to. If you set this field, then the Reserve applies to all Entities in the Org. | getOrg(): ?string | setOrg(?string org): void |
