...
# Vas Efe Offer Updates Response Item
...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(VasEfeOfferUpdatesResponse[])`](../../doc/models/vas-efe-offer-updates-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
