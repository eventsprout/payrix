...
|  --- | --- | --- | --- | --- | --- |
| `plan` | `?string` | Optional | The identifier of the Plan that this Subscription is associated with. The Plan determines the frequency and amount of each payment. | getPlan(): ?string | setPlan(?string plan): void |
