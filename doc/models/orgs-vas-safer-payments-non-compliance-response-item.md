...
# Orgs VAS Safer Payments Non Compliance Response Item

## Structure

`OrgsVASSaferPaymentsNonComplianceResponseItem`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(OrgsVASSaferPaymentsNonComplianceResponse[])`](../../doc/models/orgs-vas-safer-payments-non-compliance-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
