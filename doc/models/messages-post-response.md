...
| `read` | [`?string(MessagesReadStrEnum)`](../../doc/models/messages-read-str-enum.md) | Optional | Whether this resource is marked as read.<br><br><details><br><summary>Valid Values</summary><br>- `0` - **Message has not been read yet.**<br>- `1` - **Message has been read and a value.**<br><br></details><br> | getRead(): ?string | setRead(?string read): void |
