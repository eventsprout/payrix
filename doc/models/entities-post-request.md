...
|  --- | --- | --- | --- | --- | --- |
| `clientIp` | `?string` | Required | The client IP address from which the Entity was created. Valid values are any IPv4 or IPv6 address. | getClientIp(): ?string | setClientIp(?string clientIp): void |
...
| `name` | `string` | Required | The name of this Entity.<br>This field is stored as a string and must be between 1 and 100 characters long. | getName(): string | setName(string name): void |
...
| `address1` | `string` | Required | The first line of the address associated with this Entity.<br>This field is stored as a string and must be between 1 and 500 characters long. | getAddress1(): string | setAddress1(string address1): void |
...
| `email` | `string` | Required | The email address associated with this Entity.<br>This field is stored as a text string and must be between 1 and 100 characters long. | getEmail(): string | setEmail(string email): void |
...
| `ein` | `?string` | Required | The IRS Employer Identification Number (EIN) for the Entity.<br>This field is stored as an integer and must be 9 characters long. | getEin(): ?string | setEin(?string ein): void |
| `locations` | `?int` | Optional | The number of locations at which this Entity does business.<br>This field is stored as an integer and must be between 1 and 1,000,000 characters long.<br><br>**Default**: `1` | getLocations(): ?int | setLocations(?int locations): void |
...
| `globalBusinessId` | `?string` | Required | The business registration number for the entity.<br>This field is stored as an alphanumeric and must be between 9 to 10 characters long | getGlobalBusinessId(): ?string | setGlobalBusinessId(?string globalBusinessId): void |
| `accounts` | [`?(AccountsPostRequest[])`](../../doc/models/accounts-post-request.md) | Optional | - | getAccounts(): ?array | setAccounts(?array accounts): void |
...
| `contacts` | [`?(ContactsPostRequest[])`](../../doc/models/contacts-post-request.md) | Optional | - | getContacts(): ?array | setContacts(?array contacts): void |
| `credentials` | [`?(CredentialsPostRequest[])`](../../doc/models/credentials-post-request.md) | Optional | - | getCredentials(): ?array | setCredentials(?array credentials): void |
| `embeddedFinance` | [`?(EmbeddedFinancePostRequest[])`](../../doc/models/embedded-finance-post-request.md) | Optional | - | getEmbeddedFinance(): ?array | setEmbeddedFinance(?array embeddedFinance): void |
| `entityCustomFields` | [`?(EntityCustomFieldsPostRequest[])`](../../doc/models/entity-custom-fields-post-request.md) | Optional | - | getEntityCustomFields(): ?array | setEntityCustomFields(?array entityCustomFields): void |
| `entityData` | [`?(EntityDataPostRequest[])`](../../doc/models/entity-data-post-request.md) | Optional | - | getEntityData(): ?array | setEntityData(?array entityData): void |
| `entityRefs` | [`?(EntityRefsPostRequest[])`](../../doc/models/entity-refs-post-request.md) | Optional | - | getEntityRefs(): ?array | setEntityRefs(?array entityRefs): void |
| `entityRoutes` | [`?(EntityRoutesPostRequest[])`](../../doc/models/entity-routes-post-request.md) | Optional | - | getEntityRoutes(): ?array | setEntityRoutes(?array entityRoutes): void |
| `entityTerms` | [`?(EntityTermsPostRequest[])`](../../doc/models/entity-terms-post-request.md) | Optional | - | getEntityTerms(): ?array | setEntityTerms(?array entityTerms): void |
...
| `omniTokens` | [`?(OmniTokensPostRequest[])`](../../doc/models/omni-tokens-post-request.md) | Optional | - | getOmniTokens(): ?array | setOmniTokens(?array omniTokens): void |
| `forentityProfitShares` | [`?(ProfitSharesPostRequest[])`](../../doc/models/profit-shares-post-request.md) | Optional | - | getForentityProfitShares(): ?array | setForentityProfitShares(?array forentityProfitShares): void |
| `holds` | [`?(HoldsPostRequest[])`](../../doc/models/holds-post-request.md) | Optional | - | getHolds(): ?array | setHolds(?array holds): void |
...
| `pinlessDebitConversions` | [`?(PinlessDebitConversionsPostRequest[])`](../../doc/models/pinless-debit-conversions-post-request.md) | Optional | - | getPinlessDebitConversions(): ?array | setPinlessDebitConversions(?array pinlessDebitConversions): void |
...
| `revenueBoosts` | [`?(RevenueBoostsPostRequest[])`](../../doc/models/revenue-boosts-post-request.md) | Optional | - | getRevenueBoosts(): ?array | setRevenueBoosts(?array revenueBoosts): void |
| `vendor` | [`?VendorsPostRequest`](../../doc/models/vendors-post-request.md) | Optional | - | getVendor(): ?VendorsPostRequest | setVendor(?VendorsPostRequest vendor): void |
| `fees` | [`?(FeesPostRequest[])`](../../doc/models/fees-post-request.md) | Optional | - | getFees(): ?array | setFees(?array fees): void |
| `forentityFees` | [`?(FeesPostRequest[])`](../../doc/models/fees-post-request.md) | Optional | - | getForentityFees(): ?array | setForentityFees(?array forentityFees): void |
| `saferPayments` | [`?(SaferPaymentsPostRequest[])`](../../doc/models/safer-payments-post-request.md) | Optional | - | getSaferPayments(): ?array | setSaferPayments(?array saferPayments): void |
