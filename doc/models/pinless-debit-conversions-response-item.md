...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(PinlessDebitConversionsResponse[])`](../../doc/models/pinless-debit-conversions-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
