...
| `team` | string\|[TeamsPostRequest](../../doc/models/teams-post-request.md)\|null | Optional | The identifier (ID) of the team that this Alert relates to. The Alert is triggered based on the activity of this Team. | getTeam(): | setTeam( team): void |
...
| `alertActions` | [`?(AlertActionsPostRequest[])`](../../doc/models/alert-actions-post-request.md) | Optional | - | getAlertActions(): ?array | setAlertActions(?array alertActions): void |
| `alertTriggers` | [`?(AlertTriggersPostRequest[])`](../../doc/models/alert-triggers-post-request.md) | Optional | - | getAlertTriggers(): ?array | setAlertTriggers(?array alertTriggers): void |
