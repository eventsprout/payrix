...
# Fraud Sight Enablements Response Item

## Structure

`FraudSightEnablementsResponseItem`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(FraudSightEnablementsResponse[])`](../../doc/models/fraud-sight-enablements-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
