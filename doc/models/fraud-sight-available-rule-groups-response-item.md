...
# Fraud Sight Available Rule Groups Response Item

## Structure

`FraudSightAvailableRuleGroupsResponseItem`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(FraudSightAvailableRuleGroupsResponse[])`](../../doc/models/fraud-sight-available-rule-groups-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
