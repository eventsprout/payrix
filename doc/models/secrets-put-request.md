...
|  --- | --- | --- | --- | --- | --- |
| `login` | `?string` | Optional | The identifier of the Login that owns this secret resource. | getLogin(): ?string | setLogin(?string login): void |
...
| `org` | `?string` | Optional | The identifier of the Org associated with this secret. | getOrg(): ?string | setOrg(?string org): void |
