...
|  --- | --- | --- | --- | --- | --- |
| `login` | `string` | Required | The ID of the Login that owns this resource. | getLogin(): string | setLogin(string login): void |
...
| `invoices` | [`?(InvoicesPostRequest[])`](../../doc/models/invoices-post-request.md) | Optional | - | getInvoices(): ?array | setInvoices(?array invoices): void |
| `tokens` | [`?(TokenPostRequest[])`](../../doc/models/token-post-request.md) | Optional | - | getTokens(): ?array | setTokens(?array tokens): void |
