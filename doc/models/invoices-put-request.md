...
|  --- | --- | --- | --- | --- | --- |
| `login` | `?string` | Optional | The identifier of the Login of this invoice resource. | getLogin(): ?string | setLogin(?string login): void |
| `merchant` | `?string` | Optional | The identifier of the Merchant of this invoice resource. | getMerchant(): ?string | setMerchant(?string merchant): void |
| `customer` | `?string` | Optional | The identifier of the Customer of this invoice resource. | getCustomer(): ?string | setCustomer(?string customer): void |
| `subscription` | `?string` | Optional | The identifier of the Subscription of this invoice resource. | getSubscription(): ?string | setSubscription(?string subscription): void |
