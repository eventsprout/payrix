...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(TerminalTxnsResponse[])`](../../doc/models/terminal-txns-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
