...
|  --- | --- | --- | --- | --- | --- |
| `orgFlow` | `?string` | Optional | The identifier of the orgFlow resource that this orgFlowActions resource is associated with. | getOrgFlow(): ?string | setOrgFlow(?string orgFlow): void |
