...
| `team` | string\|[TeamsPostRequest](../../doc/models/teams-post-request.md) | Required | The identifier of the Team resource that the Login identified in the 'login' field should be marked as part of. | getTeam(): | setTeam( team): void |
