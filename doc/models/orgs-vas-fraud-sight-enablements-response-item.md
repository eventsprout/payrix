...
# Orgs VAS Fraud Sight Enablements Response Item

## Structure

`OrgsVASFraudSightEnablementsResponseItem`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(OrgsVASFraudSightEnablementsResponse[])`](../../doc/models/orgs-vas-fraud-sight-enablements-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
