...
# Org Entities Put Request

## Structure

`OrgEntitiesPutRequest`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `org` | `string` | Required | The identifier of the Org that this orgEntity is associated with. | getOrg(): string | setOrg(string org): void |
