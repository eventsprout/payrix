...
|  --- | --- | --- | --- | --- | --- |
| `txn` | `string` | Required | The identifier of the Transaction associated with this TxnDatas resource. | getTxn(): string | setTxn(string txn): void |
| `signature` | `string` | Required | The Base64 encoded image of the signature captured at the time of entering the Transaction. | getSignature(): string | setSignature(string signature): void |
