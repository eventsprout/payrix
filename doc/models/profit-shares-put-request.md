...
|  --- | --- | --- | --- | --- | --- |
| `login` | `?string` | Optional | The identifier of the Login that owns this ProfitShare. | getLogin(): ?string | setLogin(?string login): void |
| `entity` | `?string` | Optional | The identifier of the Entity that this ProfitShare refers to. This is the entity that will receive the split income/expense. | getEntity(): ?string | setEntity(?string entity): void |
| `forentity` | `?string` | Optional | The identifier of the Entity that will have it's earnings/expenses shared. | getForentity(): ?string | setForentity(?string forentity): void |
| `org` | `?string` | Optional | The identifier of the Org in which entities will have their earnings/expenses shares. | getOrg(): ?string | setOrg(?string org): void |
