...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(MessageThreadsResponse[])`](../../doc/models/message-threads-response.md) | Optional | The data object that the API returns for this request. | getData(): ?array | setData(?array data): void |
