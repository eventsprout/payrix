...
| `orgFlowActions` | [`?(OrgFlowActionsPostRequest[])`](../../doc/models/org-flow-actions-post-request.md) | Optional | - | getOrgFlowActions(): ?array | setOrgFlowActions(?array orgFlowActions): void |
| `orgFlowRules` | [`?(OrgFlowRulesPostRequest[])`](../../doc/models/org-flow-rules-post-request.md) | Optional | - | getOrgFlowRules(): ?array | setOrgFlowRules(?array orgFlowRules): void |
