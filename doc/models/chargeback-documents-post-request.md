...
|  --- | --- | --- | --- | --- | --- |
| `chargeback` | `string` | Required | The identifier of the Chargeback resource that this chargebackDocument relates to. | getChargeback(): string | setChargeback(string chargeback): void |
