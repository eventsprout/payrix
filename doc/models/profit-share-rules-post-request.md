...
|  --- | --- | --- | --- | --- | --- |
| `profitShare` | string\|[ProfitSharesPostRequest](../../doc/models/profit-shares-post-request.md) | Required | The identifier of the ProfitShare that this ProfitShare Rule applies to. | getProfitShare(): | setProfitShare( profitShare): void |
...
| `value` | `string` | Required | The value to compare against when evaluating this ProfitShare Rule. | getValue(): string | setValue(string value): void |
