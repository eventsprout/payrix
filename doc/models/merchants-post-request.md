...
|  --- | --- | --- | --- | --- | --- |
| `totalApprovedSales` | `?int` | Optional | Show the total approved amount to this merchant.<br><br>**Default**: `0` | getTotalApprovedSales(): ?int | setTotalApprovedSales(?int totalApprovedSales): void |
| `entity` | string\|[EntitiesPostRequest](../../doc/models/entities-post-request.md) | Required | The Entity associated with this Merchant. | getEntity(): | setEntity( entity): void |
...
| `annualCCSales` | `?int` | Optional | The value of the annual credit card sales of this Merchant.<br>This field is specified as an integer in cents. For example, $25.30 is expressed as '2530'.<br><br>**Default**: `0` | getAnnualCCSales(): ?int | setAnnualCCSales(?int annualCCSales): void |
...
| `avgTicket` | `?int` | Optional | The value of the average credit card sales of this Merchant.<br>This field is specified as an integer in cents. For example, $25.30 is expressed as '2530'.<br><br>**Default**: `0` | getAvgTicket(): ?int | setAvgTicket(?int avgTicket): void |
...
| `disclosureDate` | `?int` | Optional | The date the Merchant platform disclosure is reviewed by the Merchant. The format should be YYYYMMDD | getDisclosureDate(): ?int | setDisclosureDate(?int disclosureDate): void |
| `environment` | [`string(MerchantEnvironmentEnum)`](../../doc/models/merchant-environment-enum.md) | Required | The environment which the Merchant is in, if applicable.<br><br><details><br><summary>Valid Values</summary><br>- `supermarket` - **Supermarkets / Grocery**<br>- `moto` - **Mail Order / Telephone Order**<br>- `cardPresent` - **Card Present Environment**<br>- `fuel` - **Fuel / Gas Stations**<br>- `serviceStation` - **Service Stations**<br>- `restaurant` - **Restaurants**<br>- `ecommerce` - **eCommerce / Online Sales**<br></details><br> | getEnvironment(): string | setEnvironment(string environment): void |
...
| `accountClosureReasonDate` | `?int` | Optional | The date the account closure reason code was provided. The format should be YYYMMDD. | getAccountClosureReasonDate(): ?int | setAccountClosureReasonDate(?int accountClosureReasonDate): void |
...
| `batches` | [`?(BatchesPostRequest[])`](../../doc/models/batches-post-request.md) | Optional | - | getBatches(): ?array | setBatches(?array batches): void |
...
| `members` | [`?(MembersPostRequest[])`](../../doc/models/members-post-request.md) | Optional | - | getMembers(): ?array | setMembers(?array members): void |
| `plans` | [`?(PlansPostRequest[])`](../../doc/models/plans-post-request.md) | Optional | - | getPlans(): ?array | setPlans(?array plans): void |
| `terminals` | [`?(TerminalsPostRequest[])`](../../doc/models/terminals-post-request.md) | Optional | - | getTerminals(): ?array | setTerminals(?array terminals): void |
