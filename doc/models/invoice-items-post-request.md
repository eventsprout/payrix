...
|  --- | --- | --- | --- | --- | --- |
| `login` | `string` | Required | The identifier of the Login that owns this Invoiceitem. | getLogin(): string | setLogin(string login): void |
| `item` | `string` | Required | The desired name of this InvoiceItem. This field is stored as a text string and must be between 1 and 500 characters long. | getItem(): string | setItem(string item): void |
...
| `price` | `?int` | Optional | The price of this InvoiceItem is specified as an integer in cents.<br><br>**Default**: `0` | getPrice(): ?int | setPrice(?int price): void |
