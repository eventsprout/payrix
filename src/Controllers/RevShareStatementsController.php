...
class RevShareStatementsController extends BaseController
{
    /**
     ...
     *
     * @return RevShareStatementsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getRevShareStatementsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): RevShareStatementsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/revShareStatements/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(RevShareStatementsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getRevShareStatements(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/revShareStatements')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
