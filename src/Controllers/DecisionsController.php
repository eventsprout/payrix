...
class DecisionsController extends BaseController
{
     ...
     *
     * @param string $id The ID of this resource and The Decision ID.
     ...
     *
     * @return DecisionsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getDecisionsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): DecisionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/decisions/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(DecisionsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Update a Decisions resource, which represents the schedule and rules for a check done on
     * Transactions.
     *
     * @param string $id The ID of this resource and The Decision ID.
     * @param DecisionsPutRequest $body Update Decision Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putDecisionsId(
        string $id,
        DecisionsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): DecisionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/decisions/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    /**
     * Delete a Decision's resource, which represents the schedule and rules for a check done on
     * Transactions.
     *
     * @param string $id The ID of this resource, also known as The Decision ID.
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteDecisionsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): DecisionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/decisions/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    /**
     * Query a Decision's resource. A decisions resource represents the schedule and rules for a check done
     * on Transactions.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
    ...
    public function getDecisions(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/decisions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param DecisionsPostRequest $body Create Decision Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postDecisions(
        DecisionsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): DecisionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/decisions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
