...
use PayrixLib\Models\EmbeddedFinancePutRequest;
use PayrixLib\Models\EmbeddedFinanceResponseResult;

class EmbeddedFinanceController extends BaseController
{
    /**
     ...
     *
     * @return EmbeddedFinanceResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEmbeddedFinanceId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EmbeddedFinanceResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/embeddedFinance/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EmbeddedFinanceResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource.
     * @param EmbeddedFinancePutRequest $body Update embeddedFinance Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putEmbeddedFinanceId(
        string $id,
        EmbeddedFinancePutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): EmbeddedFinanceResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/embeddedFinance/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getEmbeddedFinance(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/embeddedFinance')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param EmbeddedFinancePostRequest $body Create embeddedFinance
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postEmbeddedFinance(
        EmbeddedFinancePostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): EmbeddedFinanceResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/embeddedFinance')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
