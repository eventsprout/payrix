...
class TokenResultsController extends BaseController
{
    /**
     ...
     *
     * @return TokenResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTokenResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TokenResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/tokenResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TokenResultsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getTokenResults(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/tokenResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
