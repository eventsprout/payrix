...
class FeeRefundsController extends BaseController
{
    /**
     * Query a Refund.
     *
     ...
     *
     * @return RefundsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getRefundsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): RefundsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/refunds/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(RefundsResponseResult::class);
    ...
    public function getRefunds(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/refunds')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     * Create a Refund.
     *
     * @param RefundsPostRequest $body Create a Fee Refund Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postRefunds(
        RefundsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): RefundsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/refunds')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
