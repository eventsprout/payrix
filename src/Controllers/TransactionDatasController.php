...
class TransactionDatasController extends BaseController
{
    /**
     * Query a txnDatas resource.
     * A txnDatas resource represents data associated with a Transaction - in particular, a Base64 encoded
     * image of a signature captured at the time of entering the Transaction.
     *
     ...
     *
     * @return TxnDatasResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTxnDatasId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TxnDatasResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txnDatas/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TxnDatasResponseResult::class);
    ...
    public function getTxnDatas(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txnDatas')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
    ...
    /**
     * Create a txnData. A txnDatas resource represents data associated with a Transaction - in particular,
     * a Base64 encoded image of a signature captured at the time of entering the Transaction.
     *
     * @param TxnDatasPostRequest $body Create txnDatas Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postTxnDatas(
        TxnDatasPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TxnDatasResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/txnDatas')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
