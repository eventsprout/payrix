...
class EntryOriginController extends BaseController
{
    /**
     * Query an Entry Origin.
     *
     * @param string $id The Entry Origin ID of this resource.
     ...
     *
     * @return EntryOriginsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEntryOriginsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EntryOriginsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entryOrigins/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntryOriginsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getEntryOrigins(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entryOrigins')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
