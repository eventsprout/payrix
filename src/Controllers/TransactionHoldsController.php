...
class TransactionHoldsController extends BaseController
{
    /**
     ...
     *
     * @return HoldsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getHoldsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): HoldsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/holds/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(HoldsResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource.
     * @param HoldsPutRequest $body Update Transaction Hold Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putHoldsId(
        string $id,
        HoldsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): HoldsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/holds/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    public function getHolds(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/holds')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     * A holds resource represents a reviewable action taken on a Transaction.
     *
     * @param HoldsPostRequest $body Create a Transaction Hold Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postHolds(
        HoldsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): HoldsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/holds')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
