...
class AppleDomainsController extends BaseController
{
    /**
     ...
     *
     * @return AppleDomainsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getAppleDomainsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): AppleDomainsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/appleDomains{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(AppleDomainsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getAppleDomains(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/appleDomains')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
