...
class DivisionsController extends BaseController
{
     ...
     * Query a Division.
     *
     * @param string $id The ID of this resource, The Division ID.
     ...
     *
     * @return DivisionsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getDivisionsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): DivisionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/divisions/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(DivisionsResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource, The Division ID.
     * @param DivisionsPutRequest $body Update Division Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putDivisionsId(
        string $id,
        DivisionsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): DivisionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/divisions/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    public function getDivisions(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/divisions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     * Create a Division.
     *
     * @param DivisionsPostRequest $body Create Division Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
    ...
    public function postDivisions(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/divisions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
