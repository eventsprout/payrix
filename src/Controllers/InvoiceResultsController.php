...
class InvoiceResultsController extends BaseController
{
    /**
     * Query an invoiceResults resource that represents the result of an invoice processing, which is
     * generated when a customer pays for an invoice.
     *
     * @param string $id The ID of this invoice result.
     ...
     *
     * @return InvoiceResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getInvoiceResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): InvoiceResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/invoiceResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(InvoiceResultsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query InvoiceResults resource that represents the result of an invoice processing. In other words,
     * when the customer pays for an invoice it will then generate an invoice result.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getInvoiceResults(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/invoiceResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param InvoiceResultPostRequest $body Create Invoice Result Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postInvoiceResults(
        InvoiceResultPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): InvoiceResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/invoiceResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
