...
class EntityReturnsController extends BaseController
{
    /**
     * Query an EntityReturn represents an ACH transaction or disbursement that has been rejected, which
     * will block ACH creations or send out related to its entity and payment.
     *
     * @param string $id The ID of this entity return.
     ...
     *
     * @return EntityReturnsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityReturnsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EntityReturnsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityReturns/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntityReturnsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query an EntityReturn represents an ACH transaction or disbursement that has been rejected. The
     * EntityReturn will block ACH creations or send out related to its entity and payment.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityReturns(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityReturns')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
