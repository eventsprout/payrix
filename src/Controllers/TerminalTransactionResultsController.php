...
class TerminalTransactionResultsController extends BaseController
{
    /**
     * Querying a terminalTxnResults resource represents the result of a Transaction from a processor,
     * which may be approved, declined, or raise an error.
     *
     ...
     *
     * @return TerminalTxnResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTerminalTxnResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TerminalTxnResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/terminalTxnResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TerminalTxnResultsResponseResult::class);
    ...
    /**
     * Querying a terminalTxnResults resource represents the result of a Transaction from a processor,
     * which can be approved, declined, or raise an error.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getTerminalTxnResults(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/terminalTxnResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
