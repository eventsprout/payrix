...
class HostThemesController extends BaseController
{
    /**
     * Query a Host Theme.
     *
     ...
     *
     * @return HostThemesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getHostThemesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): HostThemesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/hostThemes/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(HostThemesResponseResult::class);
    ...
    public function getHostThemes(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/hostThemes')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
