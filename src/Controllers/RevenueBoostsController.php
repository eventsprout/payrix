...
class RevenueBoostsController extends BaseController
{
    /**
     ...
     *
     * @return RevenueBoostsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getRevenueBoostsId(
        string $id,
        ?string $token = null,
        ?string $embed = null
    ): RevenueBoostsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/revenueBoosts/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(RevenueBoostsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getRevenueBoosts(
        ?string $token = null,
        ?string $search = null,
        ?string $totals = null,
        ?int $pageNumber = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/revenueBoosts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
     ...
     *
     * @param RevenueBoostsPostRequest $body Add RevenueBoosts Request
     *
     * @return RevenueBoostsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postRevenueBoosts(RevenueBoostsPostRequest $body): RevenueBoostsResponseResult
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/revenueBoosts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
