...
class PendingEntryController extends BaseController
{
    /**
     * Query a Pending Entry resource.
     *
     * @param string $id The ID of this resource or The Pending Entry ID.
     ...
     *
     * @return PendingEntriesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getPendingEntriesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): PendingEntriesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/pendingEntries/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(PendingEntriesResponseResult::class);
     ...
     * A PendingEntry resource represents a record of amounts moving in or out of the funds held by an
     * Entity.
     * For example, this could be a time-based activity such as a weekly or monthly summary, or an event-
     * based activity such as a Capture, a Payout, or a Fee. In the case of an event-based activity, the
     * PendingEntry contains references the activity in the appropriate field. Eventually the PendingEntry
     * will trigger the creation of an Entry resource and its amount will reflect any unsourced amounts for
     * the Entry.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
    ...
    public function getPendingEntries(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/pendingEntries')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
