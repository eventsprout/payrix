...
class RevShareSchedulesController extends BaseController
{
    /**
     ...
     *
     * @return RevShareSchedulesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getRevShareSchedulesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): RevShareSchedulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/revShareSchedules/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(RevShareSchedulesResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource.
     * @param RevShareSchedulesPutRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putRevShareSchedulesId(
        string $id,
        RevShareSchedulesPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): RevShareSchedulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/revShareSchedules/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteRevShareSchedulesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): RevShareSchedulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/revShareSchedules/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getRevShareSchedules(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/revShareSchedules')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param RevShareSchedulesPostRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postRevShareSchedules(
        RevShareSchedulesPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): RevShareSchedulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/revShareSchedules')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
