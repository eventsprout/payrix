...
class AggregationResultsController extends BaseController
{
    /**
     * Query an AggregationResult.
     *
     * @param string $id The ID of this resource or The Aggregation Result ID.
     ...
     *
     * @return AggregationResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getAggregationResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): AggregationResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/aggregationResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(AggregationResultsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteAggregationResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): AggregationResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/aggregationResults/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    public function getAggregationResults(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/aggregationResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
