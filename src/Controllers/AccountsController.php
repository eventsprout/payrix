...
class AccountsController extends BaseController
{
     ...
     *
     * @return AccountsResponseResult Response from the API call
     *
    ...
    public function getAccountsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/accounts/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(AccountsResponseResult::class);
     ...
     *
     * @param string $id The ID of the Account associated with the Entity's bank account.
     * @param AccountsPutRequest $body A request body for updating existing bank account information
    ...
    public function putAccountsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/accounts/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    public function deleteAccountsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/accounts/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     *
     * @param AccountsPostRequest $body Add Bank Account Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
    ...
    public function postAccounts(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/accounts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
