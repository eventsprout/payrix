...
class TerminalsController extends BaseController
{
     ...
     *
     * @param string $id The ID of this resource and The Terminal ID.
     ...
     *
     * @return TerminalsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTerminalsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TerminalsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/terminals/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TerminalsResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource and The Terminal ID.
     * @param TerminalsPutRequest $body Update Terminal Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putTerminalsId(
        string $id,
        TerminalsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TerminalsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/terminals/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    /**
     * Delete a terminal resource that represents a device/software that will be used to process
     * transactions.
     *
     * @param string $id The ID of this resource and The Terminal ID.
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteTerminalsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): TerminalsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/terminals/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * A terminal resource represents a device/software that will be used to process transactions.
     *
     * @param TerminalsPostRequest $body Create Terminal Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postTerminals(
        TerminalsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TerminalsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/terminals')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
