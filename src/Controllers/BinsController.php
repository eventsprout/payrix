...
class BinsController extends BaseController
{
     ...
     *
     * @param string $id The ID of this resource and The BIN ID.
     ...
     *
     * @return BinsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getBinsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): BinsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/bins/{id}')
    ...
    public function getBins(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/bins')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
