...
{
    /**
     * Querying a Vendor resource represents a third-party vendor who interacts with the API, for example,
     * a referral platform.
     *
     * @param string $id The ID of this resource, The Vendor ID.
     ...
     *
     * @return VendorsResponseResult Response from the API call
     *
    ...
    public function getVendorsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/vendors/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(VendorsResponseResult::class);
     ...
     *
     * Details:
     * Update a Vendor resource. A Vendor resource represents a third-party vendor who interacts with the
     * API, for example, a referral platform.
     * Query a Vendor resource.
     *
     * @param string $id The ID of this resource and The Vendor ID.
     * @param VendorsPutRequest $body Update Vendor Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putVendorsId(
        string $id,
        VendorsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): VendorsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/vendors/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    /**
     * Delete a Vendor or Vendors resource that represents a third-party vendor who interacts with the API,
     * for example, a referral platform.
     *
     * @param string $id The ID of this resource, The Vendor ID.
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteVendorsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): VendorsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/vendors/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    /**
     * Query a Vendor resource. A Vendor resource represents a third-party vendor who interacts with the
     * API, for example, a referral platform.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
    ...
    public function getVendors(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/vendors')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
