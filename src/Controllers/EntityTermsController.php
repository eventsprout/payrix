...
class EntityTermsController extends BaseController
{
    /**
     ...
     *
     * @return EntityTermsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityTermsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EntityTermsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityTerms/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntityTermsResponseResult::class);
    ...
    public function getEntityTerms(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityTerms')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param EntityTermsPostRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postEntityTerms(
        EntityTermsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): EntityTermsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/entityTerms')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
