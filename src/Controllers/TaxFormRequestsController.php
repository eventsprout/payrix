...
class TaxFormRequestsController extends BaseController
{
    /**
     * Query a taxFormRequests.
     *
     * @param string $id The ID of this Tax Form Requests.
     ...
     *
     * @return TaxFormRequestsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTaxFormRequestsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TaxFormRequestsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/taxFormRequests/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TaxFormRequestsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getTaxFormRequests(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/taxFormRequests')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param TaxFormRequestsPostRequest $body Create Tax Form Requests
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postTaxFormRequests(
        TaxFormRequestsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TaxFormRequestsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/taxFormRequests')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
