...
{
    /**
     * Query a Statement. A Statement resource represents the total collection of funds owed for a Billing
     * period.
     *
     * @param string $id The ID of this resource and The Statement ID.
     ...
     *
     * @return StatementsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getStatementsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): StatementsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/statements/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(StatementsResponseResult::class);
    ...
    public function getStatements(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/statements')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
