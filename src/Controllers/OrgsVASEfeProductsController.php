...
use PayrixLib\Models\OrgsVASEfeProductsPutRequest;
use PayrixLib\Models\OrgsVASEfeProductsResponseResult;

class OrgsVASEfeProductsController extends BaseController
{
    /**
     ...
     *
     * @return OrgsVASEfeProductsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASEfeProductsId(
        string $id,
        ?string $token = null,
        ?string $embed = null
    ): OrgsVASEfeProductsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASEfeProducts/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(OrgsVASEfeProductsResponseResult::class);
     ...
     *
     * @param string $id The ID of this Orgs VAS EfeProducts.
     * @param OrgsVASEfeProductsPutRequest $body Update Orgs VAS EfeProducts
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putOrgsVASEfeProductsId(
        string $id,
        OrgsVASEfeProductsPutRequest $body,
        ?string $token = null
    ): OrgsVASEfeProductsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/orgsVASEfeProducts/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteOrgsVASEfeProductsId(string $id, ?string $token = null): OrgsVASEfeProductsResponseResult
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/orgsVASEfeProducts/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASEfeProducts(
        ?string $token = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASEfeProducts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
     ...
     *
     * @param OrgsVASEfeProductsPostRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postOrgsVASEfeProducts(
        OrgsVASEfeProductsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgsVASEfeProductsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/orgsVASEfeProducts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
