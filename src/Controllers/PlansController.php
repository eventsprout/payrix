...
{
    /**
     * Query a Plan that represents a recurring type of payment that charges a certain amount on a weekly,
     * monthly, quarterly, or annual basis, once created, allowing association with a Subscription and user.
     *
     * @param string $id The ID of this plan.
     ...
     *
     * @return PlansResponseResult Response from the API call
     *
    ...
    public function getPlansId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/plans/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(PlansResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Update a Plan that represents a recurring type of payment that charges a certain amount on a weekly,
     * monthly, quarterly, or annual basis, once created, allowing association with a Subscription and user.
     *
     * @param string $id The ID of this plan.
     * @param PlansPutRequest $body Update plan Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putPlansId(
        string $id,
        PlansPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): PlansResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/plans/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    /**
     * Delete a Plan that represents a recurring type of payment that charges a certain amount on a weekly,
     * monthly, quarterly, or annual basis, once created, allowing association with a Subscription and user.
     *
     * @param string $id The ID of this plan.
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deletePlansId(string $id, ?string $token = null, ?string $requestToken = null): PlansResponseResult
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/plans/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    /**
     * Query a Plan.
     * A Plan represents a recurring type of payment that charges a certain amount on a weekly, monthly,
    ...
    /**
     * Create a Plan that represents a recurring type of payment that charges a certain amount on a weekly,
     * monthly, quarterly, or annual basis, which once created, allows you to associate a Subscription and
     * user with it.
     *
     * @param PlansPostRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
