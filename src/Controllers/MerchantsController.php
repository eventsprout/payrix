...
{
    /**
     * Query a Merchant, an organization that processes credit card payments, each associated with an
     * Entity.
     *
     ...
     *
     * @return MerchantsResponseResult Response from the API call
     *
    ...
    public function getMerchants(
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(MerchantsResponseResult::class);
     ...
     *
     * @param MerchantsPostRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     *        for more information.
     *
     * @return MerchantsPostResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postMerchants(
        ...
        $_resHandler = $this->responseHandler()
            ->throwErrorOn('400', ErrorType::init('Error', ErrorFourHundredException::class))
            ->type(MerchantsPostResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query a Merchant, which is an organization that processes credit card payments and each is
    ...
    public function getMerchantsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/merchants/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
    ...
    /**
     * Update a Merchant, A Merchant is an organization that processes credit card payments. Each Merchant
     * is associated with an Entity.
     *
     * @param string $id The ID of this resource, also known as the Merchant ID (MID).
     * @param MerchantsPutRequest $body Update Merchant Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putMerchantsId(
        string $id,
        MerchantsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): MerchantsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/merchants/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('Content-Type', 'application/json'),
    ...
    /**
     * Delete a Merchant. A Merchant is an organization that processes credit card payments. Each Merchant
     * is associated with an Entity.
     *
     * @param string $id The ID of this resource, also known as the Merchant ID (MID).
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteMerchantsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): MerchantsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/merchants/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
