...
class ProfitShareResultsController extends BaseController
{
    /**
     * Query a ProfitShareResult or Profit Share Result.
     *
     * @param string $id The ID of this resource, The Profit Share Result ID.
     ...
     *
     * @return ProfitShareResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getProfitShareResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): ProfitShareResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/profitShareResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ProfitShareResultsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query a ProfitShareResult or Profit Share Result resource, which holds a message regarding a failed
     * ProfitShare process.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getProfitShareResults(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/profitShareResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
