...
{
    /**
     * Query an EntityDatas containing information about that entity, such as the signature for the terms
     * and conditions.
     *
     * @param string $id The ID of this entity data.
     ...
     *
     * @return EntityDatasResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityDatasId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EntityDatasResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityDatas/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntityDatasResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query an EntityDatas, which is the data related to an entity containing information about that
     * entity such as the signature for the terms and conditions.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
    ...
    public function getEntityDatas(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityDatas')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
    ...
    /**
     * Create an EntityDatas containing the data related to an entity, including information such as the
     * signature for the terms and conditions.
     *
     * @param EntityDataPostRequest $body Create Entity Data Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postEntityDatas(
        EntityDataPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): EntityDatasResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/entityDatas')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
