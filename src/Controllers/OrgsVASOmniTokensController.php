...
class OrgsVASOmniTokensController extends BaseController
{
    /**
     ...
     *
     * @return OrgsVASOmniTokensResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASOmniTokensId(
        string $id,
        ?string $token = null,
        ?string $embed = null
    ): OrgsVASOmniTokensResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASSOmniTokens/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(OrgsVASOmniTokensResponseResult::class);
     ...
     *
     * @param string $id The ID of this Orgs VAS OmniToken.
     * @param OrgsVASOmniTokensPutRequest $body Update Orgs VAS OmniToken
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putOrgsVASOmniTokensId(
        string $id,
        OrgsVASOmniTokensPutRequest $body,
        ?string $token = null
    ): OrgsVASOmniTokensResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/orgsVASSOmniTokens/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteOrgsVASOmniTokensId(string $id, ?string $token = null): OrgsVASOmniTokensResponseResult
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/orgsVASSOmniTokens/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASOmniTokens(
        ?string $token = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASSOmniTokens')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
     ...
     *
     * @param OrgsVASOmniTokensPostRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postOrgsVASOmniTokens(
        OrgsVASOmniTokensPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgsVASOmniTokensResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/orgsVASSOmniTokens')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
