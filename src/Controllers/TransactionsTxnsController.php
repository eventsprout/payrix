...
class TransactionsTxnsController extends BaseController
{
    /**
     * Query a Transaction.
     * Transactions hold all of the information relating to a particular credit card transaction, including
     * the merchant, token, subscription, customer and card information.
     *
     ...
     *
     * @return TxnsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTxnsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TxnsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txns/{id}')
     ...
     *
     * @param string $id The ID of this transaction.
     * @param TxnsPutRequest $body Update txns Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putTxnsId(
        string $id,
        TxnsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TxnsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/txns/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    public function getTxns(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txns')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     * the merchant, token, subscription, customer and card information.
     *
     * @param TxnsPostRequest $body Create a new transaction.
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     *        for more information.
     *
     * @return TxnsPostResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postTxns(
        TxnsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TxnsPostResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/txns')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
        ...
        $_resHandler = $this->responseHandler()
            ->throwErrorOn('400', ErrorType::init('Error', ErrorFourHundredException::class))
            ->type(TxnsPostResponseResult::class);
