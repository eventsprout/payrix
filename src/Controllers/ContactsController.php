...
class ContactsController extends BaseController
{
     ...
     *
     * @param string $id The ID of this contact.
     ...
     *
     * @return ContactsResponseResult Response from the API call
     *
    ...
    public function getContactsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/contacts/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ContactsResponseResult::class);
     ...
     *
     * @param string $id The ID of this contact.
     * @param ContactsPutRequest $body Update Contact Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putContactsId(
        string $id,
        ContactsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): ContactsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/contacts/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteContactsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): ContactsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/contacts/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     *
     * @param ContactsPostRequest $body Create Contact Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
