...
class VASEfeOffersController extends BaseController
{
    /**
     ...
     *
     * @return VasEfeOffersResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getVasEfeOffersId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): VasEfeOffersResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/vasEfeOffers/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(VasEfeOffersResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getVasEfeOffers(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/vasEfeOffers')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
