...
{
    /**
     * Query a Fund, which represents a sum of money held by an Entity, and some of the amount can be
     * marked as reserved or available.
     *
     * @param string $id The ID of this resource and The Fund ID.
     ...
     *
     * @return FundsResponseResult Response from the API call
     *
    ...
    public function getFundsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/funds/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(FundsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query a Fund that represents a sum of money held by an Entity, some of which can be marked as
    ...
    public function getFunds(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/funds')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
