...
class OrgsVASRevenueBoostsController extends BaseController
{
    /**
     ...
     *
     * @return OrgsVASRevenueBoostsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASRevenueBoostsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): OrgsVASRevenueBoostsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASRevenueBoosts/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(OrgsVASRevenueBoostsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASRevenueBoosts(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASRevenueBoosts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param OrgsVASRevenueBoostsPostRequest $body Add OrgsVasNetworkPaymentManager Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postOrgsVASRevenueBoosts(
        OrgsVASRevenueBoostsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgsVASRevenueBoostsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/orgsVASRevenueBoosts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
