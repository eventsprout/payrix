...
class OrgFlowActionsController extends BaseController
{
    /**
     * Query an Org Flow Actions resource.
     *
     * @param string $id The ID of this resource or The Org Flow Action ID.
     ...
     *
     * @return OrgFlowActionsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgFlowActionsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): OrgFlowActionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgFlowActions/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(OrgFlowActionsResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource or The Org Flow Action ID.
     * @param OrgFlowActionsPutRequest $body Update an Org Flow Action Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putOrgFlowActionsId(
        string $id,
        OrgFlowActionsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgFlowActionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/orgFlowActions/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteOrgFlowActionsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgFlowActionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/orgFlowActions/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * An orgFlowActions resource lets you add an Entity defined in the associated orgFlow to an Org, or
     * remove an Entity identified in the same way from an Org.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgFlowActions(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgFlowActions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
    ...
    /**
     * Create an Org Flow Action that lets you add an Entity defined in the associated orgFlow to an Org,
     * or remove an Entity identified in the same way from an Org.
     *
     * @param OrgFlowActionsPostRequest $body Create Org Flow Action Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postOrgFlowActions(
        OrgFlowActionsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgFlowActionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/orgFlowActions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
