...
class OrgFlowRulesController extends BaseController
{
    /**
     ...
     *
     * @return OrgFlowRulesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgFlowRulesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): OrgFlowRulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgFlowRules/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(OrgFlowRulesResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource or The Org Flow Rule ID.
     * @param OrgFlowRulesPutRequest $body Update an Org Flow Rule Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putOrgFlowRulesId(
        string $id,
        OrgFlowRulesPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgFlowRulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/orgFlowRules/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteOrgFlowRulesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgFlowRulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/orgFlowRules/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgFlowRules(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgFlowRules')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param OrgFlowRulesPostRequest $body Create Org Flow Rule Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postOrgFlowRules(
        OrgFlowRulesPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgFlowRulesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/orgFlowRules')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
