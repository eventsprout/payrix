...
class PaymentUpdateGroupsController extends BaseController
{
    /**
     * Query a Payment Update Group that has a collection of payment updates owned by the merchant's entity.
     *
     * @param string $id The ID of this payment update group.
     ...
     *
     * @return PaymentUpdateGroupsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getPaymentUpdateGroupsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): PaymentUpdateGroupsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/paymentUpdateGroups/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(PaymentUpdateGroupsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getPaymentUpdateGroups(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/paymentUpdateGroups')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
