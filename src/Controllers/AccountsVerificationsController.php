...
class AccountsVerificationsController extends BaseController
{
    /**
     * Retrieve a list of all account verifications that query an accountVerifications resource,
     * representing attempts to verify the ownership of a particular bank account by verifying a known
     ...
     *
     * @return AccountVerificationsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getAccountVerificationsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): AccountVerificationsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/accountVerifications/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(AccountVerificationsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Retrieve a list of all account verifications representing attempts to verify the ownership of a
     * particular bank account by verifying a known deposit amount or credential.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
    ...
    public function getAccountVerifications(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/accountVerifications')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
