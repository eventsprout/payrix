...
class ChargebackStatusesController extends BaseController
{
    /**
     * Query ChargebackStatuses. A ChargebackStatuses is the logged status changes of a Chargeback, The
     * resource for each Chargeback gives details of the Chargeback, including the reason why it occurred
     * and the date when it occurred.
     *
     * @param string $id The Chargeback Status ID of this resource.
     ...
     *
     * @return ChargebackStatusesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackStatusesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): ChargebackStatusesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackStatuses/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ChargebackStatusesResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackStatuses(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackStatuses')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
