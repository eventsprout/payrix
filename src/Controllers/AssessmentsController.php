...
{
    /**
     * Query an Assessment resource that represents a record of fees charged by processors or other third
     * parties to Entities or Orgs. Fees can represent charges that are levied on a one-off, regularly
     * scheduled, or event-driven basis.
     *
     * @param string $id The ID of this assessment.
     ...
     *
     * @return AssessmentsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getAssessmentsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): AssessmentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/assessments/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(AssessmentsResponseResult::class);
    ...
    /**
     * Query an Assessment resource that represents a record of fees charged by processors or other third
     * parties to Entities or Orgs. These fees are levied on a one-off, regularly scheduled, or event-
     * driven basis.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
    ...
    public function getAssessments(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/assessments')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
