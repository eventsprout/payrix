...
class InvoiceItemsController extends BaseController
{
     ...
     *
     * @param string $id The ID of this invoice item.
     ...
     *
     * @return InvoiceItemsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getInvoiceItemsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): InvoiceItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/invoiceItems/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(InvoiceItemsResponseResult::class);
     ...
     *
     * @param string $id The ID of this invoice item.
     * @param InvoiceItemsPutRequest $body Update Invoice Item Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putInvoiceItemsId(
        string $id,
        InvoiceItemsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): InvoiceItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/invoiceItems/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteInvoiceItemsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): InvoiceItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/invoiceItems/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    public function getInvoiceItems(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/invoiceItems')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param InvoiceItemsPostRequest $body Create Invoice Item Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postInvoiceItems(
        InvoiceItemsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): InvoiceItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/invoiceItems')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
