...
{
    /**
     * Query a Notes resource that represents risk management notes, reviews, and releases for a Hold, Txn,
     ...
     *
     * @return NotesResponseResult Response from the API call
     *
    ...
    public function getNotesId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/notes/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(NotesResponseResult::class);
     ...
     *
     * @param string $id The ID of this note.
     * @param NotesPutRequest $body Update Note Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putNotesId(
        string $id,
        NotesPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): NotesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/notes/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteNotesId(string $id, ?string $token = null, ?string $requestToken = null): NotesResponseResult
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/notes/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    public function getNotes(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/notes')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
    ...
    /**
     * Create a Notes resource that represents risk management notes, reviews, and releases for a Hold, Txn,
     * and Entity-specific data.
     *
     * @param NotesPostRequest $body Create Note Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
    ...
    public function postNotes(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/notes')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
