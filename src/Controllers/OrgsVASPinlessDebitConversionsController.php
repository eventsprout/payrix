...
class OrgsVASPinlessDebitConversionsController extends BaseController
{
    /**
     ...
     *
     * @return OrgsVASPinlessDebitConversionsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASPinlessDebitConversionsId(
        string $id,
        ?string $token = null,
        ?string $embed = null
    ): OrgsVASPinlessDebitConversionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASPinlessDebitConversions/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(OrgsVASPinlessDebitConversionsResponseResult::class);
     ...
     *
     * @param string $id The ID of this Orgs VAS Pinless Debit Conversions.
     * @param OrgsVASPinlessDebitConversionsPutRequest $body Update Orgs VAS Pinless Debit
     *        Conversions
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putOrgsVASPinlessDebitConversionsId(
        string $id,
        OrgsVASPinlessDebitConversionsPutRequest $body,
        ?string $token = null
    ): OrgsVASPinlessDebitConversionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/orgsVASPinlessDebitConversions/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getOrgsVASPinlessDebitConversions(
        ?string $token = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/orgsVASPinlessDebitConversions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
     ...
     *
     * @param OrgsVASPinlessDebitConversionsPostRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postOrgsVASPinlessDebitConversions(
        OrgsVASPinlessDebitConversionsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): OrgsVASPinlessDebitConversionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/orgsVASPinlessDebitConversions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
