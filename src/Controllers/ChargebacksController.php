...
class ChargebacksController extends BaseController
{
    /**
     * Query a Chargeback. A Chargeback is the reversal of a Transaction and means that the funds have been
     * returned to their source. The resource for a Chargeback gives details of the Chargeback, including
     * the reason why it occurred and the date when it occurred.
     *
     * @param string $id The ID of the Chargeback.
     ...
     *
     * @return ChargebacksResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebacksId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): ChargebacksResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebacks/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ChargebacksResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query Chargebacks. A Chargeback is the reversal of a Transaction, meaning that the funds have been
     * returned to their source. The resource for each Chargeback gives details of the Chargeback,
    ...
    public function getChargebacks(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebacks')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
