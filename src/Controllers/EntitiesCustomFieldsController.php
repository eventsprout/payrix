...
class EntitiesCustomFieldsController extends BaseController
{
    /**
     ...
     *
     * @return EntityCustomFieldsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityCustomFieldsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EntityCustomFieldsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityCustomFields/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntityCustomFieldsResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource.
     * @param EntityCustomFieldsPutRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putEntityCustomFieldsId(
        string $id,
        EntityCustomFieldsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): EntityCustomFieldsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/entityCustomFields/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteEntityCustomFieldsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): EntityCustomFieldsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/entityCustomFields/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityCustomFields(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityCustomFields')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
    ...
    /**
     * Create an Entity Custom Field. Custom Fields can be added to entities associated by the Entity Id.
     * An Entity Id can have various fields associated to it.
     *
     * @param EntityCustomFieldsPostRequest $body Add Entity Cutom Field Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postEntityCustomFields(
        EntityCustomFieldsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): EntityCustomFieldsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/entityCustomFields')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
