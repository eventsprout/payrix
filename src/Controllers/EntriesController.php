...
class EntriesController extends BaseController
{
     ...
     *
     * @param string $id The ID of this resource and The Entry ID.
     ...
     *
     * @return EntriesResponseResult Response from the API call
     *
    ...
    public function getEntriesId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entries/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntriesResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query an Entry resource. An Entry resource represents a record of amounts moving in or out of the
     * funds held by an Entity. This could be a time-based activity such as a weekly or monthly summary, or
     * an event-based activity such as a Capture, a Payout, or a Fee. In the case of an event-based
     * activity, the Entry contains references to the activity in the appropriate field.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
    ...
    public function getEntries(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entries')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
