...
class InvoiceLineItemsController extends BaseController
{
    /**
     * Query an InvoiceLineItem or Invoice Line Item.
     *
     * @param string $id The ID of this invoice line item.
     ...
     *
     * @return InvoiceLineItemsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getInvoiceLineItemsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): InvoiceLineItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/invoiceLineItems/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(InvoiceLineItemsResponseResult::class);
     ...
     *
     * @param string $id The ID of this invoice line item.
     * @param InvoiceLineItemsPutRequest $body Update Invoice Line Item Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putInvoiceLineItemsId(
        string $id,
        InvoiceLineItemsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): InvoiceLineItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/invoiceLineItems/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteInvoiceLineItemsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): InvoiceLineItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/invoiceLineItems/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    /**
     * Query an InvoiceLineItem. InvoiceLineItem is a resource that relates an invoice item with an invoice.
    ...
    public function getInvoiceLineItems(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/invoiceLineItems')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
    ...
    /**
     * Create an InvoiceLineItem or Invoice Line Item.InvoiceLineItem is a resource that relates an invoice
     * item with an invoice. It holds information such as quantity, and price each item.
     *
     * @param InvoiceLineItemsPostRequest $body Create Invoice Line Item Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postInvoiceLineItems(
        InvoiceLineItemsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): InvoiceLineItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/invoiceLineItems')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
