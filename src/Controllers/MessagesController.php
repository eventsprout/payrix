...
class MessagesController extends BaseController
{
     ...
     *
     * @param string $id The ID of this message.
     ...
     *
     * @return MessagesResponseResult Response from the API call
     *
    ...
    public function getMessagesId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/messages/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(MessagesResponseResult::class);
     ...
     *
     * @param string $id The ID of this message.
     * @param MessagesPutRequest $body Update Message Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
    ...
    public function putMessagesId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/messages/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    public function getMessages(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/messages')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param MessagesPostRequest $body Create Message Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     *        for more information.
     *
     * @return MessagesPostResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postMessages(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/messages')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
        ...
        $_resHandler = $this->responseHandler()
            ->throwErrorOn('400', ErrorType::init('Error', ErrorFourHundredException::class))
            ->type(MessagesPostResponseResult::class);
