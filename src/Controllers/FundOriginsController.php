...
class FundOriginsController extends BaseController
{
    /**
     * Query a Fund Origin.
     *
     * @param string $id The ID of this resource and The Fund Origin ID.
     ...
     *
     * @return FundOriginsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getFundOriginsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): FundOriginsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/fundOrigins/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(FundOriginsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getFundOrigins(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/fundOrigins')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
