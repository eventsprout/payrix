...
class EntityRefsController extends BaseController
{
    /**
     * Query an EntityRefs resource that represents a reference code issued by the Processor that
     * represents a particular Entity.
     *
     * @param string $id The ID of this entity reference.
     ...
     *
     * @return EntityRefsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityRefsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EntityRefsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityRefs/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntityRefsResponseResult::class);
    ...
    public function getEntityRefs(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityRefs')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
