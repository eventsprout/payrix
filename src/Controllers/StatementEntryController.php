...
class StatementEntryController extends BaseController
{
    /**
     * Query a StatementEntry resource. A StatementEntry resource represents a record of funds owed for a
     * billing schedule.
     *
     * @param string $id The ID of this statement entry.
     ...
     *
     * @return StatementEntriesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getStatementEntriesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): StatementEntriesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/statementEntries/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(StatementEntriesResponseResult::class);
     ...
     * For example, this could be a scheduled weekly or monthly fee, or an event-based activity such as a
     * capture or payout fee.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getStatementEntries(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/statementEntries')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
