...
class ChargebackMessageResultsController extends BaseController
{
    /**
     * Query a chargebackMessageResults resource, which represents a message that is received from the
     * processor in relation to a Chargeback message.
     *
     * @param string $id The Chargeback Message Result ID of this resource.
     ...
     *
     * @return ChargebackMessageResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackMessageResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): ChargebackMessageResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackMessageResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ChargebackMessageResultsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackMessageResults(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackMessageResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
