...
class ChargebackMessagesController extends BaseController
{
    /**
     * Query a chargebackMessage. A chargebackMessage resource represents a message that is sent by a
     * Merchant, processor, or bank in relation to a Chargeback.
     *
     * @param string $id The ID of this chargeback message.
     ...
     *
     * @return ChargebackMessagesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackMessagesId(
        string $id,
        ?string $token = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackMessages/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ChargebackMessagesResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query a chargebackMessage resource, which represents a message that is sent by a Merchant, processor,
     * or bank in relation to a Chargeback.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackMessages(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackMessages')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
    ...
    /**
     * Create a chargebackMessage. A chargebackMessage resource represents a message that is sent by a
     * Merchant, processor, or bank in relation to a Chargeback.
     *
     * @param ChargebackMessagePostRequest $body Create Chargeback Message Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postChargebackMessages(
        ChargebackMessagePostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): ChargebackMessagesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/chargebackMessages')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
