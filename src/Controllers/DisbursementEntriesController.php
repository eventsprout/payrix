...
class DisbursementEntriesController extends BaseController
{
    /**
     * Query a Disbursement Entry that is a record of where a disbursement amount is coming from.
     *
     * @param string $id The ID of this disbursement entry.
     ...
     *
     * @return DisbursementEntriesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getDisbursementEntriesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): DisbursementEntriesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursementEntries/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(DisbursementEntriesResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getDisbursementEntries(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursementEntries')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
