...
class TransactionItemsController extends BaseController
{
    /**
     * Query an Item.
     * An Item is a line item that is associated with a particular Transaction. It allows you to describe
     * the cost, quantity and other details of each line in the Transaction.
     *
     ...
     *
     * @return ItemsResponseResult Response from the API call
     *
    ...
    public function getItemsId(
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ItemsResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource.
     * @param ItemsPutRequest $body Update Item Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putItemsId(
        string $id,
        ItemsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): ItemsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/items/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteItemsId(string $id, ?string $token = null, ?string $requestToken = null): ItemsResponseResult
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/items/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * the cost, quantity and other details of each line in the Transaction.
     *
     * @param ItemsPostRequest $body Create an Item Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
