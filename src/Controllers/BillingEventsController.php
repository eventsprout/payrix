...
class BillingEventsController extends BaseController
{
    /**
     * Query a Billing Event.
     *
     * @param string $id The ID of this billing event.
     ...
     *
     * @return BillingEventsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getBillingEventsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): BillingEventsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/billingEvents/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(BillingEventsResponseResult::class);
     ...
     *
     * @param string $id The ID of this billing event.
     * @param BillingEventsPutRequest $body Update Billing Event Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putBillingEventsId(
        string $id,
        BillingEventsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): BillingEventsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/billingEvents/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteBillingEventsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): BillingEventsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/billingEvents/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    public function getBillingEvents(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/billingEvents')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param BillingEventsPostRequest $body Create Billing Event Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postBillingEvents(
        BillingEventsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): BillingEventsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/billingEvents')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
