...
class AdjustmentsController extends BaseController
{
     ...
     *
     * @param string $id The ID of this resource and The Adjustment ID.
     ...
     *
     * @return AdjustmentsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getAdjustmentsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): AdjustmentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/adjustments/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(AdjustmentsResponseResult::class);
    ...
    public function getAdjustments(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/adjustments')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
