...
class TransactionsResultsController extends BaseController
{
    /**
     ...
     *
     * @return TxnResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTxnResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TxnResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txnResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TxnResultsResponseResult::class);
    ...
    public function getTxnResults(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txnResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
