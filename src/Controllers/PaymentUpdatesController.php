...
class PaymentUpdatesController extends BaseController
{
    /**
     * _CONFLICT Query a Payment Update that holds information about the payment update, related to a
     * payment, subscriptionToken or account, and owned by a paymentUpdateGroup.
     *
     * @param string $id The ID of this payment update.
     ...
     *
     * @return PaymentUpdatesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getPaymentUpdatesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): PaymentUpdatesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/paymentUpdates/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(PaymentUpdatesResponseResult::class);
     ...
     * A PaymentUpdate holds information about the payment update. The paymentUpdate will be related to a
     * payment, subscriptionToken or account, and owned by a paymentUpdateGroup.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getPaymentUpdates(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/paymentUpdates')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
