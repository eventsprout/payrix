...
class VASEfeOfferUpdatesController extends BaseController
{
    /**
     ...
     *
     * @return VasEfeOfferUpdatesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getVasEfeOfferUpdatesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): VasEfeOfferUpdatesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/vasEfeOfferUpdates/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(VasEfeOfferUpdatesResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getVasEfeOfferUpdates(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/vasEfeOfferUpdates')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
