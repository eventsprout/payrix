...
class DisbursementResultsController extends BaseController
{
    /**
     * Query a Disbursement Result resource, representing a reference code issued by the Payout facilitator
     * when a Disbursement is paid.
     *
     ...
     *
     * @return DisbursementResultsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getDisbursementResultsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): DisbursementResultsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursementResults/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(DisbursementResultsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query Disbursement Result resources, each of which represents a reference code issued by the Payout
     * facilitator when a Disbursement is paid.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getDisbursementResults(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursementResults')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
