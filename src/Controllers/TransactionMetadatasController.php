...
class TransactionMetadatasController extends BaseController
{
    /**
     * Query a txnMetadatas resource.
     * A txnMetadatas resource represents data from an EMV Transaction and/or returned by the credit card
     * network associated with a Transaction.
     *
     ...
     *
     * @return TxnMetaDatasResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTxnMetadatasId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TxnMetaDatasResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txnMetadatas/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TxnMetaDatasResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getTxnMetadatas(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/txnMetadatas')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
