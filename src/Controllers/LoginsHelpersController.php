...
class LoginsHelpersController extends BaseController
{
    /**
     ...
     *
     * @return LoginsHelpersResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getLoginsHelpersId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): LoginsHelpersResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/loginsHelpers/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(LoginsHelpersResponseResult::class);
     ...
     *
     * @param string $id The ID of this resource.
     * @param LoginsHelpersPutRequest $body
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putLoginsHelpersId(
        string $id,
        LoginsHelpersPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): LoginsHelpersResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/loginsHelpers/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getLoginsHelpers(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/loginsHelpers')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
