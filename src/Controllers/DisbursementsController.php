...
{
    /**
     * Query a Disbursement, which represents a record of an occasion where money is either paid to a bank
     * account or received from a bank account.
     *
     ...
     *
     * @return DisbursementsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getDisbursementsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): DisbursementsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursements/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(DisbursementsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query Disbursements, each of which represents a record of an occasion where money is either paid to
     * a bank account or received from a bank account.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
    ...
    public function getDisbursements(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursements')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
