...
class PinlessDebitConversionsController extends BaseController
{
    /**
     * Query a pinlessDebitConversion.
     *
     * @param string $id The ID of this pinlessDebitConversion.
     ...
     *
     * @return PinlessDebitConversionsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getPinlessDebitConversionsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): PinlessDebitConversionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/pinlessDebitConversions/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(PinlessDebitConversionsResponseResult::class);
     ...
     *
     * @param string $id The ID of this Pinless Debit Conversions.
     * @param PinlessDebitConversionsPutRequest $body Update Pinless Debit Conversions
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putPinlessDebitConversionsId(
        string $id,
        PinlessDebitConversionsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): PinlessDebitConversionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/pinlessDebitConversions/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getPinlessDebitConversions(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/pinlessDebitConversions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param PinlessDebitConversionsPostRequest $body Create Pinless Debit Conversions Request.
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postPinlessDebitConversions(
        PinlessDebitConversionsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): PinlessDebitConversionsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/pinlessDebitConversions')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
