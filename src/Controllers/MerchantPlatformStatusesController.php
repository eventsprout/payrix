...
class MerchantPlatformStatusesController extends BaseController
{
    /**
     ...
     *
     * @return MerchantPlatformStatusesResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getMerchantPlatformStatusesId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): MerchantPlatformStatusesResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/merchantPlatformStatuses/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(MerchantPlatformStatusesResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getMerchantPlatformStatuses(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/merchantPlatformStatuses')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
