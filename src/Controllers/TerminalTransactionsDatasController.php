...
class TerminalTransactionsDatasController extends BaseController
{
    /**
     ...
     *
     * @return TerminalTxnDatasResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getTerminalTxnsDatasId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): TerminalTxnDatasResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/terminalTxnDatas/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TerminalTxnDatasResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getTerminalTxnsDatas(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/terminalTxnDatas')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param TerminalTxnsDatasPostRequest $body Create Terminal Transaction Data Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postTerminalTxnsDatas(
        TerminalTxnsDatasPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TerminalTxnDatasResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/terminalTxnDatas')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
