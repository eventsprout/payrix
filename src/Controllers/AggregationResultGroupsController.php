...
class AggregationResultGroupsController extends BaseController
{
    /**
     * Query an AggregationResultGroup resource, which holds data regarding a processed aggregation.
     *
     * @param string $id The ID of this resource or The Aggregation Result Group ID.
     ...
     *
     * @return AggregationResultsGroupsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getAggregationResultGroupsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): AggregationResultsGroupsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/aggregationResultGroups/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(AggregationResultsGroupsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteAggregationResultGroupsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $searchFilter = null
    ): AggregationResultsGroupsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/aggregationResultGroups/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getAggregationResultGroups(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/aggregationResultGroups')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
