...
class TeamsController extends BaseController
{
     ...
     *
     * @return TeamsResponseResult Response from the API call
     *
    ...
    public function getTeamsId(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/teams/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(TeamsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Update a Team, A Team is a collection of Logins, You can associate Logins with a Team by creating
     * teamLogin resources.
     *
     * @param string $id The ID of this team.
     * @param TeamsPutRequest $body Update Team Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putTeamsId(
        string $id,
        TeamsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): TeamsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/teams/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
    ...
    /**
     * Delete a Team, A Team is a collection of Logins, You can associate Logins with a Team by creating
     * teamLogin resources.
     *
     * @param string $id The ID of this team.
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteTeamsId(string $id, ?string $token = null, ?string $requestToken = null): TeamsResponseResult
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/teams/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    public function getTeams(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/teams')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     * You can associate Logins with a Team by creating teamLogin resources.
     *
     * @param TeamsPostRequest $body Create Team Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
    ...
    public function postTeams(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/teams')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
