...
class NoteDocumentsController extends BaseController
{
    /**
     * Query a Note Document that represents a file that is related to a specific note record.
     *
     * @param string $id The ID of this note document.
     ...
     *
     * @return NoteDocumentsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getNoteDocumentsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): NoteDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/noteDocuments/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(NoteDocumentsResponseResult::class);
     ...
     *
     * @param string $id The ID of this note document.
     * @param NoteDocumentsPutRequest $body Update Note Document Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putNoteDocumentsId(
        string $id,
        NoteDocumentsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): NoteDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/noteDocuments/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteNoteDocumentsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): NoteDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/noteDocuments/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    /**
     * Query a Note Document, which represents a file that is related to a specific note record and
     * documents resources.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
    ...
    public function getNoteDocuments(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/noteDocuments')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param NoteDocumentsPostRequest $body Create Note Document Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postNoteDocuments(
        NoteDocumentsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): NoteDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/noteDocuments')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
