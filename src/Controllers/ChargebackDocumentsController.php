...
class ChargebackDocumentsController extends BaseController
{
    /**
     * Query a chargebackDocument. A chargebackDocument resource represents a file related to a Chargeback.
     *
     * @param string $id The ID of this chargeback document.
     ...
     *
     * @return ChargebackDocumentsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackDocumentsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): ChargebackDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackDocuments/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ChargebackDocumentsResponseResult::class);
     ...
     *
     * @param string $id The ID of this chargeback document.
     * @param ChargebacksDocumentsPutRequest $body Update Chargeback Document Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function putChargebackDocumentsId(
        string $id,
        ChargebacksDocumentsPutRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): ChargebackDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/chargebackDocuments/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteChargebackDocumentsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): ChargebackDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/chargebackDocuments/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getChargebackDocuments(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/chargebackDocuments')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
     ...
     *
     * @param ChargebackDocumentsPostRequest $body Create Chargeback Document Request
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     *        guide/references/authentication/auth-tokens" target="_blank">Auth Tokens</a> add
     *        security by requiring one-time approval for specific actions.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function postChargebackDocuments(
        ChargebackDocumentsPostRequest $body,
        ?string $token = null,
        ?string $requestToken = null
    ): ChargebackDocumentsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/chargebackDocuments')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('Content-Type', 'application/json'),
                BodyParam::init($body),
