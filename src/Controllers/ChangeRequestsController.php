...
class ChangeRequestsController extends BaseController
{
     ...
     *
     * @return ChangeRequestsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getChangeRequestsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): ChangeRequestsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/changeRequests/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ChangeRequestsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function deleteChangeRequestsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null
    ): ChangeRequestsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/changeRequests/{id}')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                TemplateParam::init('id', $id),
                HeaderParam::init('token', $token),
    ...
    public function getChangeRequests(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/changeRequests')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
