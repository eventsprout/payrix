...
class DisbursementReferenceController extends BaseController
{
    /**
     * Query a Disbursement Reference that represents a reference code issued by the Payout facilitator
     ...
     *
     * @return DisbursementRefsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getDisbursementRefsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): DisbursementRefsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursementRefs/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(DisbursementRefsResponseResult::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getDisbursementRefs(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/disbursementRefs')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
