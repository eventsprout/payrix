...
class EntityDebtsController extends BaseController
{
    /**
     * Query an EntityDebt resource.
     *
     * @param string $id The ID of this entity debt.
     ...
     *
     * @return EntityDebtsResponseResult Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityDebtsId(
        string $id,
        ?string $token = null,
        ?string $requestToken = null,
        ?string $embed = null
    ): EntityDebtsResponseResult {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityDebts/{id}')
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(EntityDebtsResponseResult::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Query an EntityDebt resource, which represents a record of a debt between entities or an entity and
     * the System.
     *
     * @param string|null $token A single-use, limited authentication layer in addition to an API
     *        Key or Session Key to authorize sensitive operations. <a href="/apis/payrix/dev-int-
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getEntityDebts(
        ?string $token = null,
        ?string $requestToken = null,
        ?string $search = null,
        ?string $totals = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/entityDebts')
            ->auth('apiKey', 'sessionKey', 'txnSessionKey')
            ->parameters(
                HeaderParam::init('token', $token),
                HeaderParam::init('request-token', $requestToken),
