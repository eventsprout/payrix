...
class TxnResultsResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     *
     * @maps type
     * @factory \PayrixLib\Models\TxnResultTypeEnum::checkValue
     */
     ...
     *
     * @maps code
     * @factory \PayrixLib\Models\TxnResultsCodeEnum::checkValue
     */
    ...
    /**
     * Converts the TxnResultsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the TxnResultsResponse object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->type)) {
            $json['type']         = TxnResultTypeEnum::checkValue($this->type);
        }
        if (isset($this->message)) {
            $json['message']      = $this->message;
        }
        if (isset($this->code)) {
            $json['code']         = TxnResultsCodeEnum::checkValue($this->code);
        }
