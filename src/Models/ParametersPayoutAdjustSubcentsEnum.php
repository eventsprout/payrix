...
class ParametersPayoutAdjustSubcentsEnum
{
    /**
     * No adjustment for sub-cents.
     */
    public const NO = 0;

    /**
     * Sub-cents are processed as an adjustment.
     */
    public const YES = 1;
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ParametersPayoutAdjustSubcentsEnum.");
    }
}
