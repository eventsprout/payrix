...
class ParametersDiscoverEnabledEnum
{
    /**
     * Discover processing is disabled
     */
    public const DISABLED = 0;

    /**
     * Discover processing is enabled
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ParametersDiscoverEnabledEnum.");
    }
}
