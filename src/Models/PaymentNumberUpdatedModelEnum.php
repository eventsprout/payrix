...
class PaymentNumberUpdatedModelEnum
{
    /**
     * Payment number is not updated.
     */
    public const NOTUPDATED = 0;

    /**
     * Payment number is updated.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for PaymentNumberUpdatedModelEnum.");
    }
}
