...
class TxnsMobileEnum
{
    /**
     * Non-mobile POS.
     */
    public const NONMOBILEPOS = 0;

    /**
     * Mobile POS.
     */
    public const MOBILEPOS = 1;

    private const _ALL_VALUES = [self::NONMOBILEPOS, self::MOBILEPOS];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TxnsMobileEnum.");
    }
}
