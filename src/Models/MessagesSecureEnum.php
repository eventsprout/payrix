...
class MessagesSecureEnum
{
    /**
     * Messages will be protected in email notifications.
     */
    public const PROTECTED_ = 0;

    /**
     * Message will display entirely.
     */
    public const DISPLAYED = 1;

    private const _ALL_VALUES = [self::PROTECTED_, self::DISPLAYED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MessagesSecureEnum.");
    }
}
