...
class ChargebacksActionableEnum
{
    /**
     * Not actionable.
     */
    public const NOTACTIONABLE = 0;

    /**
     * Actionable.
     */
    public const ACTIONABLE = 1;

    private const _ALL_VALUES = [self::NOTACTIONABLE, self::ACTIONABLE];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ChargebacksActionableEnum.");
    }
}
