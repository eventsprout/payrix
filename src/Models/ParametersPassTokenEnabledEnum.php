...
class ParametersPassTokenEnabledEnum
{
    /**
     * Pass Token is disabled
     */
    public const DISABLED = 0;

    /**
     * Pass Token is enabled
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ParametersPassTokenEnabledEnum.");
    }
}
