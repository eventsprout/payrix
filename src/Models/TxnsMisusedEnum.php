...
class TxnsMisusedEnum
{
    /**
     * Not misused
     */
    public const NOTMISUSED = 0;

    /**
     * Misused
     */
    public const MISUSED = 1;

    private const _ALL_VALUES = [self::NOTMISUSED, self::MISUSED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TxnsMisusedEnum.");
    }
}
