...
class StatementEntriesDeductedFromBalanceEnum
{
    /**
     * Not deducted from balance.
     */
    public const NOTDEDUCTED = 0;

    /**
     * Deducted from balance.
     */
    public const DEDUCTED = 1;

    private const _ALL_VALUES = [self::NOTDEDUCTED, self::DEDUCTED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for StatementEntriesDeductedFromBalanceEnum.");
    }
}
