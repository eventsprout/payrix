...
class TerminalTxnResultsResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     *
     * @maps type
     * @factory \PayrixLib\Models\TerminalTxnResultTypeEnum::checkValue
     */
     ...
     * - `1` - **Partially approved. The processor has only approved a portion of the total transaction
     * amount.**
     ...
     * - `5` - **The ZIP code in the Transaction data does not match the customer details held by the card
     * issuer.**
     * - `6` - **The address in the Transaction data does not match the customer details held by the card
     * issuer.**
     * - `7` - **The name in the Transaction data does not match the customer details held by the card
     * issuer.**
     * - `8` - **The name and phone number in the Transaction data do not match the details held by the
     * card issuer.**
     * - `9` - **The name and email address in the Transaction data do not match the customer details held
     * by the card issuer.**
     * - `10` - **The phone number in the Transaction data does not match the customer details held by the
     * card issuer.**
     * - `11` - **The phone number and email address in the Transaction data do not match the customer
     * details held by the card issuer.**
     * - `12` - **The email address in the Transaction data does not match the customer details held by the
     * card issuer.**
     ...
     * - `20` - **Non-sufficient funds. The customer did not have sufficient credit or balance to cover the
     * Transaction.**
     ...
     *
     * @maps code
     * @factory \PayrixLib\Models\TerminalTxnsResultCodeEnum::checkValue
     */
     ...
     * Exact message code as received from the activation integration or from the processor for the
    ...
    /**
     * Returns Bank Code.
     * Exact message code as received from the activation integration or
     ...
     * - `OVER_CHAIN_DAILY_VELOCITY_LIMITS` - **over_chain_product_velocity_limits**
     ...
     *
     * @maps bankCode
     * @factory \PayrixLib\Models\TerminalTxnResultsBankCodeEnum::checkValue
     */
    ...
    /**
     * Converts the TerminalTxnResultsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the TerminalTxnResultsResponse object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->type)) {
            $json['type']         = TerminalTxnResultTypeEnum::checkValue($this->type);
        }
        if (isset($this->message)) {
            $json['message']      = $this->message;
        }
        if (isset($this->code)) {
            $json['code']         = TerminalTxnsResultCodeEnum::checkValue($this->code);
        }
        if (isset($this->originalCode)) {
            $json['originalCode'] = $this->originalCode;
        }
        if (isset($this->bankCode)) {
            $json['bankCode']     = TerminalTxnResultsBankCodeEnum::checkValue($this->bankCode);
        }
