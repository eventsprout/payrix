...
class DecisionsResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * @var DecisionActionsResponse[]|null
     */
    private $decisionActions;

    /**
     * @var DecisionRulesResponse[]|null
     */
    ...
    /**
     * Returns Division.
     * The identifier of the Division that this decision resource belongs to.
     *
    ...
    /**
     * Returns Partition.
     * The identifier of the Partition that this decision resource belongs to.
     *
     ...
     *
     * @return DecisionActionsResponse[]|null
     */
    public function getDecisionActions(): ?array
    {
        return $this->decisionActions;
    }

    /**
     * Sets Decision Actions.
     *
     * @maps decisionActions
     *
     * @param DecisionActionsResponse[]|null $decisionActions
     */
    public function setDecisionActions(?array $decisionActions): void
    {
        $this->decisionActions = $decisionActions;
    }

    /**
     * Returns Decision Rules.
     *
     * @return DecisionRulesResponse[]|null
     */
     ...
     * @maps decisionRules
     *
     * @param DecisionRulesResponse[]|null $decisionRules
     */
    public function setDecisionRules(?array $decisionRules): void
    {
     ...
     * Returns Watchlist.
     *
     * @return WatchlistsResponse[]|null
     */
     ...
     * @maps watchlist
     *
     * @param WatchlistsResponse[]|null $watchlist
     */
    public function setWatchlist(?array $watchlist): void
    {
        $this->watchlist = $watchlist;
    }

    /**
     * Converts the DecisionsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the DecisionsResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'frozen' => $this->frozen,
                'decisionActions' => $this->decisionActions,
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->decisionActions)) {
            $json['decisionActions']   = $this->decisionActions;
        }
        if (isset($this->decisionRules)) {
            $json['decisionRules']     = $this->decisionRules;
        }
