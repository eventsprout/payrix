...
class FeesPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Returns Finish.
     * The date when the fee schedule ends.
     * Must be specified in YYYYMMDD format and represent a future date.
     * Once the `finish` date is reached, the `inactive` parameter is automatically set to `1`, indicating
     * the fee is no longer active.
     */
    ...
    /**
     * Converts the FeesPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the FeesPutRequest object.
     */
