...
class AlertTriggersResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the AlertTriggersResponse object to a human-readable string representation.
     *
     * @return string The string representation of the AlertTriggersResponse object.
     */
