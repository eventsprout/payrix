...
class VendorFeesEnabledEnum
{
    /**
     * Third parties cannot charge fees.
     */
    public const DISABLED = 0;

    /**
     * Third parties can charge fees.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for VendorFeesEnabledEnum.");
    }
}
