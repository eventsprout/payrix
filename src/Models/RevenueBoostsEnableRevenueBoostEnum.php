...
class RevenueBoostsEnableRevenueBoostEnum
{
    /**
     * Not EnableRevenueBoost
     */
    public const NOTENABLED = 0;
    ...
    private const _ALL_VALUES = [self::NOTENABLED, self::ENABLED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for RevenueBoostsEnableRevenueBoostEnum.");
    }
}
