...
class FeesTxnFeeEnum
{
    /**
     * Fee will be calculated normally.
     */
    public const DISABLED = 0;

    /**
     * Fee will be calculated based on transaction fee.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for FeesTxnFeeEnum.");
    }
}
