...
class RevShareSchedulesPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the RevShareSchedulesPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the RevShareSchedulesPutRequest object.
     */
