...
class DecisionActionsPostRequest implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * DecisionAction; when grouping is used, the DecisionActions will not apply unless they all match.
     */
    public function unsetGrouping(): void
    {
        $this->grouping = [];
    }
    ...
    /**
     * Converts the DecisionActionsPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DecisionActionsPostRequest object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->grouping)) {
            $json['grouping']    = $this->grouping['value'];
        }
