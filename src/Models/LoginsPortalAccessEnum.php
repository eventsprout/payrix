...
class LoginsPortalAccessEnum
{
     ...
     */
    public const HASACCESS = 1;

    private const _ALL_VALUES = [self::NOACCESS, self::HASACCESS];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for LoginsPortalAccessEnum.");
    }
}
