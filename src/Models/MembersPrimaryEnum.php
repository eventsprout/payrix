...
class MembersPrimaryEnum
{
    /**
     * Not Primary contact.
     */
    public const NOTPRIMARYCONTACT = 0;

    /**
     * Primary contact.
     */
    public const PRIMARYCONTACT = 1;

    private const _ALL_VALUES = [self::NOTPRIMARYCONTACT, self::PRIMARYCONTACT];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MembersPrimaryEnum.");
    }
}
