...
class TerminalTxnsEmvEnum
{
    /**
     * Not dipped.
     */
    public const NOTDIPPED = 0;

    /**
     * Dipped.
     */
    public const DIPPED = 1;

    private const _ALL_VALUES = [self::NOTDIPPED, self::DIPPED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TerminalTxnsEmvEnum.");
    }
}
