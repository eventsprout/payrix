...
class AlertTriggersPostRequest implements \JsonSerializable
{
    /**
     ...
     * @param int $resource
     */
    public function __construct($alert, string $event, int $resource)
    {
        $this->alert = $alert;
        $this->event = $event;
    ...
    /**
     * Converts the AlertTriggersPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the AlertTriggersPostRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'AlertTriggersPostRequest',
            [
                'alert' => $this->alert,
                'event' => $this->event,
