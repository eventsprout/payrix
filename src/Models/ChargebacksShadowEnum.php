...
class ChargebacksShadowEnum
{
    /**
     * Not shadowed.
     */
    public const NOTSHADOWED = 0;

    /**
     * Shadowed.
     */
    public const SHADOWED = 1;

    private const _ALL_VALUES = [self::NOTSHADOWED, self::SHADOWED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ChargebacksShadowEnum.");
    }
}
