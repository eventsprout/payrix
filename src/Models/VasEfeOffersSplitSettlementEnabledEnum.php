...
class VasEfeOffersSplitSettlementEnabledEnum
{
    /**
     * Split settlement is not enabled.
     */
    public const ENUM_0 = 0;

    /**
     * Split settlement is enabled.
     */
    public const ENABLED = 1;

    private const _ALL_VALUES = [self::ENUM_0, self::ENABLED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for VasEfeOffersSplitSettlementEnabledEnum.");
    }
}
