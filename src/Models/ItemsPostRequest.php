...
class ItemsPostRequest implements \JsonSerializable
{
    /**
     * @var string|TxnsPostRequest
     */
    private $txn;
     ...
     * @param int $price
     */
    public function __construct($txn, string $item, int $quantity, int $price)
    {
        $this->txn = $txn;
        $this->item = $item;
     ...
     * @required
     * @maps txn
     * @mapsBy anyOf(string,TxnsPostRequest)
     *
     * @param string|TxnsPostRequest $txn
     */
    ...
    /**
     * Converts the ItemsPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ItemsPostRequest object.
     */
