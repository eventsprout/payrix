...
class FeeModifiersPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the FeeModifiersPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the FeeModifiersPutRequest object.
     */
