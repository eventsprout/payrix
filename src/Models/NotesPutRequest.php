...
class NotesPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the NotesPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the NotesPutRequest object.
     */
