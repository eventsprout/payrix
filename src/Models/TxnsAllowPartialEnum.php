...
class TxnsAllowPartialEnum
{
    /**
     * Partial amount authorizations are not allowed.
     */
    public const NOTALLOWED = 0;
    ...
    private const _ALL_VALUES = [self::NOTALLOWED, self::ALLOWED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TxnsAllowPartialEnum.");
    }
}
