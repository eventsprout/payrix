...
class InvoiceParameterLockedEnum
{
    /**
     * Not locked.
     */
    public const NOTLOCKED = 0;
    ...
    private const _ALL_VALUES = [self::NOTLOCKED, self::LOCKED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for InvoiceParameterLockedEnum.");
    }
}
