...
class TerminalTxnsHsaFsaCardIndicatorEnum
{
    /**
     * Not an HSA/FSA card.
     */
    public const NOTHSAFSA = 0;

    /**
     * HSA/FSA card.
     */
    public const HSAFSA = 1;

    private const _ALL_VALUES = [self::NOTHSAFSA, self::HSAFSA];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TerminalTxnsHsaFsaCardIndicatorEnum.");
    }
}
