...
class SimplifiedDepositEnabledEnum
{
    /**
     * Enabled for simplified deposits. It cannot be updated to 0.
     */
    public const ENABLED = 1;

    private const _ALL_VALUES = [self::ENABLED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for SimplifiedDepositEnabledEnum.");
    }
}
