...
class TxnMetadatasResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TxnMetadatasResponse object to a human-readable string representation.
     *
     * @return string The string representation of the TxnMetadatasResponse object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->txn)) {
            $json['txn']      = ApiHelper::getJsonHelper()->verifyTypes($this->txn, 'anyOf(anyOf(string),null)');
        }
        if (isset($this->type)) {
