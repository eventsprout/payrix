...
class AccountPrimaryEnum
{
    /**
     * Not primary
     */
    public const NOTPRIMARY = 0;
    ...
    private const _ALL_VALUES = [self::NOTPRIMARY, self::PRIMARY];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for AccountPrimaryEnum.");
    }
}
