...
class NoteDocumentsPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the NoteDocumentsPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the NoteDocumentsPutRequest object.
     */
