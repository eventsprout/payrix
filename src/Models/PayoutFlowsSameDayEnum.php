...
class PayoutFlowsSameDayEnum
{
    /**
     * Same day payouts are not allowed.
     */
    public const DISABLED = 0;

    /**
     * Same day payouts are allowed.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for PayoutFlowsSameDayEnum.");
    }
}
