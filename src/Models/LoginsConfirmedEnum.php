...
class LoginsConfirmedEnum
{
    /**
     * The email is not confirmed.
     */
    public const NOTCONFIRMED = 0;
    ...
    private const _ALL_VALUES = [self::NOTCONFIRMED, self::CONFIRMED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for LoginsConfirmedEnum.");
    }
}
