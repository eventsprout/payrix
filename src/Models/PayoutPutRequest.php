...
class PayoutPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PayoutPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the PayoutPutRequest object.
     */
