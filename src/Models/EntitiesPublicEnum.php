...
class EntitiesPublicEnum
{
    /**
     * The entity is privately held.
     */
    public const PRIVATEENTITY = 0;

    /**
     * The entity is publicly held.
     */
    public const PUBLICENTITY = 1;

    private const _ALL_VALUES = [self::PRIVATEENTITY, self::PUBLICENTITY];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for EntitiesPublicEnum.");
    }
}
