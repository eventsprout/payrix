...
class TeamLoginTeamAdminEnum
{
    /**
     * No team administration rights.
     */
    public const NONE = 0;

    /**
     * Team administration rights are allowed.
     */
    public const ALLOW = 1;

    private const _ALL_VALUES = [self::NONE, self::ALLOW];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TeamLoginTeamAdminEnum.");
    }
}
