...
class ChargebackMessageImportedEnum
{
    /**
     * Not imported.
     */
    public const NOTIMPORTED = 0;
    ...
    private const _ALL_VALUES = [self::NOTIMPORTED, self::IMPORTED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ChargebackMessageImportedEnum.");
    }
}
