...
class EntityDefaultEnum
{
    /**
     * Not default
     */
    public const NOTDEFAULT = 0;
    ...
    private const _ALL_VALUES = [self::NOTDEFAULT, self::DEFAULT_];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for EntityDefaultEnum.");
    }
}
