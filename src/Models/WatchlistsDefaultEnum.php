...
class WatchlistsDefaultEnum
{
    /**
     * Non-Default
     */
    public const NONDEFAULT = 0;

    /**
     * Default
     */
    public const DEFAULT_ = 1;

    private const _ALL_VALUES = [self::NONDEFAULT, self::DEFAULT_];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for WatchlistsDefaultEnum.");
    }
}
