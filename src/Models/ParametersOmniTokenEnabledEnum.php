...
class ParametersOmniTokenEnabledEnum
{
    /**
     * Omni Token is disabled
     */
    public const DISABLED = 0;

    /**
     * Omni Token is enabled
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ParametersOmniTokenEnabledEnum.");
    }
}
