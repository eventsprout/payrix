...
class ParametersECheckEnabledEnum
{
    /**
     * eCheck processing is disabled.
     */
    public const DISABLED = 0;

    /**
     * eCheck processing is enabled.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ParametersECheckEnabledEnum.");
    }
}
