...
class TerminalTxnsTerminalCapabilityEnum
{
    /**
     ...
     * Contactless entry
     */
    public const CONTACTLESS = 4;

    private const _ALL_VALUES = [self::KEYED, self::MAGSTRIPE, self::EMV, self::CONTACTLESS];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TerminalTxnsTerminalCapabilityEnum.");
    }
}
