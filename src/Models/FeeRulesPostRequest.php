...
class FeeRulesPostRequest implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * @param string $value
     */
    public function __construct(string $fee, string $type, string $value)
    {
        $this->fee = $fee;
        $this->type = $type;
        $this->value = $value;
    ...
    /**
     * Converts the FeeRulesPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the FeeRulesPostRequest object.
     */
