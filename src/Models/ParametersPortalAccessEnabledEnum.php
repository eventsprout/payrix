...
class ParametersPortalAccessEnabledEnum
{
    /**
     * Portal access is not enabled by default.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ParametersPortalAccessEnabledEnum.");
    }
}
