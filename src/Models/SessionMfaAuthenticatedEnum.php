...
class SessionMfaAuthenticatedEnum
{
    /**
     * MFA is disabled.
     */
    public const MFADISABLED = 0;

    /**
     * MFA is enabled.
     */
    public const MFAENABLED = 1;

    private const _ALL_VALUES = [self::MFADISABLED, self::MFAENABLED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for SessionMfaAuthenticatedEnum.");
    }
}
