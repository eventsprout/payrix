...
class MccsResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * @var string|null
     */
    private $type = MccTypeEnum::WHITELIST;
    ...
    /**
     * Returns Login.
     * The identifier of the Login that owns this Mccs resource.
     *
     * @return string|LoginsResponse|null
     */
    ...
    /**
     * Returns Org.
     * The identifier of the Org associated with this Mcc resource.
     *
    ...
    /**
     * Returns Entity.
     * The identifier of the Entity associated with this Mcc resource.
     *
     ...
     *
     * `1711` - **Air Conditioning Contractors - Sales and Installation, Heating Contractors - Sales,
     * Service, Installation**
     *
     * `1731` - **Electrical Contractors**
     *
     * `1740` - **Insulation - Contractors, Masonry, Stonework Contractors, Plastering Contractors,
     ...
     * `4011` - **Railroads**
     *
     * `4111` - **Local/Suburban Commuter Passenger Transportation - Railroads, Ferries, Local Water
     * Transportation**
     *
     ...
     *
     * `4214` - **Motor Freight Carriers, Moving and Storage Companies, Trucking - Local/Long Distance,
     ...
     *
     * `5813` - **Drinking Places (Alcoholic Beverages), Bars, Taverns, Cocktail Lounges, Nightclubs and
     * Discotheques**
     *
     ...
     *
     * `5961` - **Mail Order Houses Including Catalog Order Stores, Book/Record Clubs (No longer
     * permitted for U.S. original presentments)**
     *
     ...
     *
     * `6051` - **Non-Financial Institutions - Foreign Currency, Money Orders (not wire transfer) and
     * Travelers Cheques**
     *
     ...
     *
     * `7997` - **Membership Clubs (Sports, Recreation, Athletic), Country Clubs, and Private Golf
     * Courses**
     *
     ...
     *
     * @maps mcc
     * @factory \PayrixLib\Models\MccsMccCodeEnum::checkValue
     */
     ...
     *
     * @maps type
     * @factory \PayrixLib\Models\MccTypeEnum::checkValue
     */
    ...
    /**
     * Returns Division.
     * The Division on which this MCC applies.
     *
    ...
    /**
     * Returns Partition.
     * The Partition on which this MCC applies.
     *
    ...
    /**
     * Converts the MccsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the MccsResponse object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->mcc)) {
            $json['mcc']       = MccsMccCodeEnum::checkValue($this->mcc);
        }
        if (isset($this->type)) {
            $json['type']      = MccTypeEnum::checkValue($this->type);
        }
