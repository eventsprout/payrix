...
class SessionSsoEnum
{
    /**
     * Session not created with SSO.
     */
    public const NOTCREATEDWITHSSO = 0;

    /**
     * Session created with SSO.
     */
    public const CREATEDWITHSSO = 1;

    private const _ALL_VALUES = [self::NOTCREATEDWITHSSO, self::CREATEDWITHSSO];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for SessionSsoEnum.");
    }
}
