...
class TerminalTxnsSwipedEnum
{
    /**
     * Not swiped.
     */
    public const NOTSWIPED = 0;

    /**
     * Swiped.
     */
    public const SWIPED = 1;

    private const _ALL_VALUES = [self::NOTSWIPED, self::SWIPED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TerminalTxnsSwipedEnum.");
    }
}
