...
class SubscriptionsPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the SubscriptionsPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the SubscriptionsPutRequest object.
     */
