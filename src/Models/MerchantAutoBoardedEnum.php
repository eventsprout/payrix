...
class MerchantAutoBoardedEnum
{
    /**
     * Not Auto-Boarded
     */
    public const NOTAUTOBOARDED = 0;

    /**
     * Auto-Boarded
     */
    public const AUTOBOARDED = 1;

    private const _ALL_VALUES = [self::NOTAUTOBOARDED, self::AUTOBOARDED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MerchantAutoBoardedEnum.");
    }
}
