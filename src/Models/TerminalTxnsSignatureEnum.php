...
class TerminalTxnsSignatureEnum
{
    /**
     * Not captured.
     */
    public const NOTCAPTURED = 0;
    ...
    private const _ALL_VALUES = [self::NOTCAPTURED, self::CAPTURED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TerminalTxnsSignatureEnum.");
    }
}
