...
class DivisionsCanUsePlaidWrapperMicroserviceEnum
{
    /**
     * The user cannot use the Plaid Wrapper Microservice.
     */
    public const NO = 0;

    /**
     * The user can use the Plaid Wrapper Microservice.
     */
    public const YES = 1;
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for DivisionsCanUsePlaidWrapperMicroserviceEnum.");
    }
}
