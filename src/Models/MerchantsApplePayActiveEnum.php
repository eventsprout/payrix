...
class MerchantsApplePayActiveEnum
{
    /**
     * Apple Pay is inactive for this merchant.
     */
    public const INACTIVE = 0;

    /**
     * Apple Pay is active for this merchant.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MerchantsApplePayActiveEnum.");
    }
}
