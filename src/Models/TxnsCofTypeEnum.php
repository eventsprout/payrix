...
class TxnsCofTypeEnum
{
    ...
    private const _ALL_VALUES = [self::SINGLE, self::SCHEDULED, self::UNSCHEDULED, self::INSTALLMENT];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TxnsCofTypeEnum.");
    }
}
