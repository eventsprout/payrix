...
class MerchantsSeasonalEnum
{
    /**
     * Year-Round Merchant
     */
    public const YEARROUND = 0;

    /**
     * Seasonal Merchant
     */
    public const SEASONAL = 1;

    private const _ALL_VALUES = [self::YEARROUND, self::SEASONAL];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MerchantsSeasonalEnum.");
    }
}
