...
class MerchantsVisaDisclosureIPEnum
{
    /**
     * Not Accepted
     */
    public const NOTACCEPTED = 0;
    ...
    private const _ALL_VALUES = [self::NOTACCEPTED, self::ACCEPTED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MerchantsVisaDisclosureIPEnum.");
    }
}
