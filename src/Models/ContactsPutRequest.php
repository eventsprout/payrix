...
class ContactsPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ContactsPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ContactsPutRequest object.
     */
