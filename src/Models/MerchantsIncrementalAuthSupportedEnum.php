...
class MerchantsIncrementalAuthSupportedEnum
{
    /**
     * Incremental Auth Not Supported
     */
    public const NOTSUPPORTED = 0;
    ...
    private const _ALL_VALUES = [self::NOTSUPPORTED, self::SUPPORTED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MerchantsIncrementalAuthSupportedEnum.");
    }
}
