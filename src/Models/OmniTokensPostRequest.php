...
class OmniTokensPostRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the OmniTokensPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the OmniTokensPostRequest object.
     */
