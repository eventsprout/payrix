...
class OrgFlowRulesPutRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the OrgFlowRulesPutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the OrgFlowRulesPutRequest object.
     */
