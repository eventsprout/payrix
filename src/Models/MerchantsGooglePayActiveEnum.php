...
class MerchantsGooglePayActiveEnum
{
    /**
     * Google Pay is inactive for this merchant.
     */
    public const INACTIVE = 0;

    /**
     * Google Pay is active for this merchant.
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for MerchantsGooglePayActiveEnum.");
    }
}
