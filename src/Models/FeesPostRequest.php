...
class FeesPostRequest implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * If the 'um' field is set to 'amount', then this field specifies the Fee in cents(up to three decimal
     * points)
     */
    ...
    /**
     * Returns Currency.
     * The currency of the amount in the fees resource. See <a href="https://www.iban.com/currency-codes"
     ...
     * Returns Fee Rules.
     *
     * @return FeeRulesPostRequest[]|null
     */
     ...
     * @maps feeRules
     *
     * @param FeeRulesPostRequest[]|null $feeRules
     */
    ...
    /**
     * Converts the FeesPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the FeesPostRequest object.
     */
