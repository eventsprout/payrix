...
class BillingEventsDeductFromBalanceEnum
{
    /**
     * Do not deduct from balance.
     */
    public const DONOTDEDUCT = 0;
    ...
    private const _ALL_VALUES = [self::DONOTDEDUCT, self::DEDUCT];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for BillingEventsDeductFromBalanceEnum.");
    }
}
