...
class FeeTypeEnum
{
    ...
    /**
     * A Third-Party Platform Fee.
     */
    public const ASSESSMENT = 2;

    private const _ALL_VALUES = [self::FEE, self::ASSESSMENT];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for FeeTypeEnum.");
    }
}
