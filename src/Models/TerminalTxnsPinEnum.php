...
class TerminalTxnsPinEnum
{
    /**
     * No PIN verification.
     */
    public const NOPIN = 0;
    ...
    private const _ALL_VALUES = [self::NOPIN, self::PIN];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for TerminalTxnsPinEnum.");
    }
}
