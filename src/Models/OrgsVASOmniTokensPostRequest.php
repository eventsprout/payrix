...
class OrgsVASOmniTokensPostRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the OrgsVASOmniTokensPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the OrgsVASOmniTokensPostRequest object.
     */
