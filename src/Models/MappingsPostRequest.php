...
class MappingsPostRequest implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the MappingsPostRequest object to a human-readable string representation.
     *
     * @return string The string representation of the MappingsPostRequest object.
     */
