...
class ParametersPayoutDelayIncludeOffDaysEnum
{
    /**
     * Weekends and holidays are not counted in the payout delay.
     */
    public const NO = 0;

    /**
     * Weekends and holidays are counted in the payout delay.
     */
    public const YES = 1;
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for ParametersPayoutDelayIncludeOffDaysEnum.");
    }
}
