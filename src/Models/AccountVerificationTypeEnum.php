...
class AccountVerificationTypeEnum
{
    /**
    ...
    private const _ALL_VALUES = [self::DEBIT, self::CREDENTIALS];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for AccountVerificationTypeEnum.");
    }
}
